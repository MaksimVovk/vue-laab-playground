...
const additionalPages = [
  {
    ...
    props: {
      ...
      description:
        'A centralized color palette for the application, showcasing primary and secondary colors to ensure visual consistency across all interfaces.',
    },
  },
  {
    name: 'Icons',
...
const menuGroupsDescription = {
  ...
  Other:
    'Components that do not fit into the above categories but are essential for the design system.',
}

createLab({ components, menuGroupsDescription, configuration, additionalPages }).mount('#app')
