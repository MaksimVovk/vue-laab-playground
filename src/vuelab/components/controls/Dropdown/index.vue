<template>
  <CtrlLayout :name="title" class="vue-lab__dropdown">
    <div
    ...
    >
      <div class="vue-lab__dropdown-modal">
        <Search size="sm" focus @input="handleSearch" />
        <EmptyScreen v-if="!filteredOptions.length" :size="'sm'">No options found</EmptyScreen>
        <ul v-else class="vue-lab__dropdown-list custom-scroll">
          <li
