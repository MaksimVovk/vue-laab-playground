...
<style lang="scss" scoped>
  ...
  .vue-lab__search {
    $self: &;
    $sizes: (
      sm: (padding: 5px 10px, fontsize: 14px, top: 7px, topAfter: -12px, leftBefore: 10px, leftAfter: 10px),
      md: (padding: 10px 10px, fontsize: 14px, top: 13px, topAfter: -12px, leftBefore: 10px, leftAfter: 0px),
      lg: (padding: 15px 10px, fontsize: 14px, top: 17px, topAfter: -12px, leftBefore: 10px, leftAfter: 0px),
    );
