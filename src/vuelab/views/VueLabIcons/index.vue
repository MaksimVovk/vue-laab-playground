<template>
  <Page v-if="isLoading" :is-controls="!!controls.length" class="vue-lab-icons">
    <div class="vue-lab-icons__body">
      ...
      <div class="vue-lab-icons__body-components custom-scroll--simple">
        ...
        <div class="vue-lab-icons__body-components-list">
          <EmptyScreen v-if="!groups.length" size="lg">No icons found</EmptyScreen>
          <IconGroup
            v-else
    ...
    <div v-if="controls.length" class="vue-lab-icons__controls">
      <ControlBlock
        :options="controls"
        :values="config"
