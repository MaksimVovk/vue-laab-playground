<template>
  <Page :is-controls="false" class="vue-lab-colors">
    <div class="vue-lab-colors__component">
      ...
      <div class="vue-lab-colors__component__content custom-scroll--simple">
        ...
        <Divider />
        <template v-for="(color, index) of colorGroup" :key="`color-block-${color.title}-${index}`">
          <ColorBlock :title="color.title" :options="color.options" />
