...
import { openBlock as R, createElementBlock as $, normalizeClass as De, renderSlot as lt, computed as P, createElementVNode as M, toDisplayString as oe, createCommentVNode as ne, Fragment as he, renderList as Se, createBlock as V, createStaticVNode as Ca, resolveComponent as zt, resolveDirective as ai, withDirectives as ri, withCtx as ve, resolveDynamicComponent as ct, createTextVNode as ze, ref as Q, createVNode as ke, useCssVars as oi, normalizeStyle as Ze, onMounted as Fe, nextTick as rt, watch as Ye, withKeys as nt, normalizeProps as Ys, guardReactiveProps as Ia, useAttrs as Ni, mergeProps as li, getCurrentInstance as Ti, inject as nn, withModifiers as Ve, onBeforeUnmount as ki, defineComponent as Ma, h as Oi, toHandlers as La, createSlots as Da, reactive as Ut, markRaw as Ai, createApp as Ba } from "vue";
import { createRouter as Pa, createWebHistory as Ua } from "vue-router";
const ie = (s, n) => {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = P(() => [`vue-lab__lab-button_size-${e.size}`, `vue-lab__lab-button_palette-${e.palette}`]), o = { props: e, emit: i, classes: a, handleClick: () => i("click"), computed: P };
    return Object.defineProperty(o, "__isScriptSetup", { enumerable: !1, value: !0 }), o;
  }
};
function za(s, n, t, e, i, a) {
  return R(), $(
    "div",
    {
...
const Xs = /* @__PURE__ */ ie($a, [["render", za], ["__scopeId", "data-v-5643684a"], ["__file", "./index.vue"]]), Fa = {
  __name: "index",
  props: {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = P(() => [`vue-lab-tag_size-${e.size}`, `vue-lab-tag_palette-${e.palette}`]), l = P(() => e.title == null ? "Null" : e.title), c = { props: e, emit: i, classes: a, label: l, handleClick: () => i("input", e.value), computed: P };
...
function qa(s, n, t, e, i, a) {
  return R(), $(
    "div",
    {
      class: De(["vue-lab-tag", ...e.classes, {
...
const lr = /* @__PURE__ */ ie(Za, [["render", or], ["__scopeId", "data-v-845d1c40"], ["__file", "./item.vue"]]), Xe = () => {
  ...
  setup(s, { expose: n }) {
    n();
    const e = { props: s, computed: P, PropsDescriptionItem: lr, get generateKey() {
      return Xe;
    } };
    return Object.defineProperty(e, "__isScriptSetup", { enumerable: !1, value: !0 }), e;
  }
  ...
  return R(), $("div", vr, [
    ...
    M("div", yr, [
      (R(!0), $(
        he,
        null,
        Se(t.data, (l) => (R(), V(e.PropsDescriptionItem, {
...
const Qs = /* @__PURE__ */ ie(br, [["render", Er], ["__scopeId", "data-v-db8d12a1"], ["__file", "./index.vue"]]), wr = {
  __name: "index",
  props: {
    data: {
      type: Array,
  ...
  setup(s, { expose: n }) {
    n();
    const e = { props: s, get generateKey() {
      return Xe;
    } };
    return Object.defineProperty(e, "__isScriptSetup", { enumerable: !1, value: !0 }), e;
  }
}, xr = { class: "vue-lab__events" }, Sr = { class: "vue-lab__events__body" }, Nr = { class: "vue-lab__events__body-content" }, Tr = { class: "vue-lab__events__body-column vue-lab__events__body-column--td bold" }, kr = { class: "vue-lab__events__body-column vue-lab__events__body-column--td vue-lab__events__body-column--td-regular" };
function Or(s, n, t, e, i, a) {
  return R(), $("div", xr, [
    n[1] || (n[1] = M(
      "div",
...
const Js = /* @__PURE__ */ ie(wr, [["render", Or], ["__scopeId", "data-v-7b2edc41"], ["__file", "./index.vue"]]), Ar = {}, Rr = {
  "aria-hidden": "true",
  height: "16",
  viewBox: "0 0 16 16",
  version: "1.1",
...
function Dr(s, n) {
  return R(), $("svg", Lr, [...n[0] || (n[0] = [
    Ca('<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="7" height="9" x="3" y="3" rx="1"></rect><rect width="7" height="5" x="14" y="3" rx="1"></rect><rect width="7" height="9" x="14" y="12" rx="1"></rect><rect width="7" height="5" x="3" y="16" rx="1"></rect></g>', 1)
  ])]);
}
const ea = /* @__PURE__ */ ie(Mr, [["render", Dr], ["__file", "./DefaultMenuIcon.vue"]]), Br = {}, Pr = {
  fill: "#4fa760",
  width: "32px",
  height: "32px",
  viewBox: "0 0 32 32",
...
const ta = /* @__PURE__ */ ie(Br, [["render", Ur], ["__file", "./LabIcon.vue"]]), $r = {}, zr = {
  height: "5",
  version: "1.1",
  width: "9",
  class: "octicon octicon-copy js-clipboard-copy-icon"
...
function Vr(s, n, t, e, i, a) {
  ...
  return R(), $("div", qr, [
    ...
    e.isShowList && e.isOpened ? (R(), V(e.Popover, {
      key: 0,
          ...
          e.isSearchEmpty ? (R(), $("div", jr, " No results found ")) : (R(!0), $(
            ...
            Se(e.filteredOptions, (c) => (R(), $("div", {
              ...
              c ? (R(), V(l, {
                ...
                default: ve(() => [
                  c.icon ? (R(), V(ct(c.icon), { key: 0 })) : (R(), V(e.DefaultMenuIcon, {
                    key: 1,
...
function Jr(s, n, t, e, i, a) {
  ...
  return t.item ? (R(), V(l, {
    ...
    to: t.item.path,
    title: t.item.name,
    class: De(["vue-lab__nav-item", {
      "vue-lab__nav-item--active": e.isActive
    }])
  }, {
    default: ve(() => [
      M("div", Xr, [
        t.item.icon ? (R(), V(ct(t.item.icon), { key: 0 })) : (R(), V(e.DefaultMenuIcon, {
          key: 1,
...
const eo = /* @__PURE__ */ ie(Yr, [["render", Jr], ["__scopeId", "data-v-875f6eef"], ["__file", "./item.vue"]]), to = {
  ...
  setup(s, { expose: n }) {
    ...
    }), f = { props: t, isOpened: e, toggleOpened: i, arrowClasses: a, listClasses: l, maxHeight: o, maxHeightDuration: c, ref: Q, computed: P, NavItem: eo, get generateKey() {
      return Xe;
    }, get ArrowIcon() {
      return Kr;
    } };
    ...
    M(
      ...
      [
        (R(!0), $(
          he,
          null,
          Se(t.option.items, (l) => (R(), V(e.NavItem, {
            key: e.generateKey(l),
            item: l,
            path: t.path
          }, null, 8, ["item", "path"]))),
...
const so = /* @__PURE__ */ ie(to, [["render", io], ["__scopeId", "data-v-4061da29"], ["__file", "./group.vue"]]), ao = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = P(() => {
      const f = e.options.map((y) => y.group), g = [...new Set(f)].filter((y) => y && y.length).map((y) => ({
        name: y,
        items: e.options.filter((d) => d.group === y)
      })), x = {
        name: null,
        items: e.options.filter((y) => !y.group || !y.group.length)
      };
      let N = [...g];
      return x.items.length && N.push(x), N;
    }), l = P(() => e.options.some((f) => f.group && f.group.length)), c = { props: e, emit: i, menuItems: a, isGroup: l, goToHome: () => {
      i("navigate", "/");
...
function po(s, n, t, e, i, a) {
  return R(), $("div", ro, [
    ...
    M("div", co, [
      ke(e.Search, { options: t.options }, null, 8, ["options"])
    ]),
    M("div", _o, [
      ...
      M("div", uo, [
        (R(!0), $(
          he,
          null,
          Se(e.menuItems, (l) => (R(), V(e.NavGroup, {
            key: e.generateKey(l),
            option: l,
            path: t.path,
            isGroup: e.isGroup
...
const fo = /* @__PURE__ */ ie(ao, [["render", po], ["__scopeId", "data-v-3672c48c"], ["__file", "./index.vue"]]), ho = {
  ...
  setup(s, { expose: n }) {
    ...
    function a() {
      ...
      let { width: f, height: u, left: g, top: b, right: x, bottom: N, position: y, alignment: d } = t;
      if (d || (d = e.value.width > window.innerWidth - c.left && c.right > e.value.width ? "right" : "left", f = Math.max(e.value.width, c.width)), d === "left" ? g = c.left + "px" : x = window.innerWidth - c.right + "px", window.innerHeight - c.bottom < 300)
        switch (y) {
          case "top":
            y = "bottom";
            break;
      ...
      switch (y) {
        ...
        case "left":
          ...
          break;
        case "right":
          g = c.right + +t.margin + "px";
          break;
      }
      e.value = {
        width: f ? f + "px" : void 0,
        height: u ? u + "px" : void 0,
        left: t.centered ? "50%" : g,
        top: t.centered ? "50%" : b,
...
const na = /* @__PURE__ */ ie(ho, [["render", go], ["__scopeId", "data-v-22f54b08"], ["__file", "./index.vue"]]), mo = {
  __name: "index",
  props: {
  ...
  setup(s, { expose: n, emit: t }) {
    ...
    const a = t, l = Q(null), o = P(() => [`vue-lab__search_size-${e.size}`]), u = { props: e, uuid: i, emit: a, searchInput: l, classes: o, handleInput: (g) => {
      a("input", g.target.value);
    }, unFocus: () => {
      l.value.blur();
...
const _i = /* @__PURE__ */ ie(mo, [["render", Eo], ["__scopeId", "data-v-06e447f6"], ["__file", "./index.vue"]]), wo = {
  ...
  setup(s, { expose: n, emit: t }) {
    ...
    ]), f = { emit: e, props: i, sizeValue: a, iconStyles: l, classes: o, handleClick: () => e("click"), computed: P };
    return Object.defineProperty(f, "__isScriptSetup", { enumerable: !1, value: !0 }), f;
  }
}, xo = ["viewBox"];
...
const Oo = /* @__PURE__ */ ie(To, [["render", ko], ["__file", "./SadIcon.vue"]]), Ao = {
  __name: "index",
  props: {
    size: {
      type: [String],
  ...
  setup(s, { expose: n, emit: t }) {
    ...
    }), l = { props: e, emit: i, iconSize: a, computed: P, SadIcon: Oo };
    return Object.defineProperty(l, "__isScriptSetup", { enumerable: !1, value: !0 }), l;
  }
...
const ui = /* @__PURE__ */ ie(Ao, [["render", Io], ["__scopeId", "data-v-c7a78350"], ["__file", "./index.vue"]]), Mo = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = P(() => e.slotConfig?.props ? Array.isArray(e.slotConfig.props) ? e.slotConfig?.props?.length ? e.slotConfig?.props?.reduce((o, c) => ({
      ...o,
      [c.name]: c.value
    }), {}) : {} : {
      ...e.slotConfig?.props
...
function Do(s, n, t, e, i, a) {
  return t.slotConfig.type == "text" ? (R(), $(
    ...
    64
    /* STABLE_FRAGMENT */
  )) : t.slotConfig.type == "component" ? (R(), V(
    ct(t.slotConfig.value),
    Ys(li({ key: 1 }, e.attrs)),
    null,
    16
    /* FULL_PROPS */
  )) : t.slotConfig.type == "html" ? (R(), $("div", {
    key: 2,
...
const _t = /* @__PURE__ */ ie(Go, [["render", jo], ["__scopeId", "data-v-9214d2d0"], ["__file", "./CtrlLayout.vue"]]), Vo = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, l = { props: e, emit: i, setValue: (o) => {
      i("input", o);
...
function Yo(s, n, t, e, i, a) {
  return R(), V(e.CtrlLayout, { name: t.title }, {
    default: ve(() => [
      M("div", Zo, [
        (R(!0), $(
          he,
          null,
          Se(t.options, (l) => (R(), V(e.Tag, {
            key: e.generateKey(l),
            value: l,
            isActive: l == t.value,
            title: l,
...
const Ci = /* @__PURE__ */ ie(Vo, [["render", Yo], ["__scopeId", "data-v-6c569ff9"], ["__file", "./index.vue"]]), Xo = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = Q(0), l = Q(null), o = Q(null), c = Q(null), f = P(() => e.options.length), u = (p) => {
      if (typeof p == "number" && Number.isInteger(p) && p >= 0 && p < f.value)
        return p;
      const T = e.options.findIndex((r) => String(r) === String(p));
      return T >= 0 ? T : 0;
    };
    Ye(() => e.value, (p) => {
      a.value = u(p);
    ...
    const g = P(() => {
      const p = f.value;
      return p === 1 ? [0] : Array.from({ length: p }, (T, r) => r / (p - 1) * 100);
    }), b = P(() => e.options[a.value]);
    let x = !1, N = null;
    const y = (p, T, r) => Math.max(T, Math.min(r, p)), d = (p) => {
      const T = o.value.getBoundingClientRect(), E = y(p - T.left, 0, T.width) / T.width, S = Math.round(E * (f.value - 1));
      return y(S, 0, f.value - 1);
    }, _ = (p) => {
      a.value = y(p, 0, f.value - 1);
    }, m = (p) => {
      const T = d(p.clientX);
      _(T);
    }, A = (p) => {
      x = !0, N = p.pointerId, p.target.setPointerCapture(N), window.addEventListener("pointermove", k), window.addEventListener("pointerup", L);
    };
    function k(p) {
      if (!x || p.pointerId !== N)
        return;
    ...
    const L = () => {
      if (x) {
        ...
        N = null, window.removeEventListener("pointermove", k), window.removeEventListener("pointerup", L);
      }
    }, v = (p) => {
      _(a.value + p);
    };
    ki(() => {
      window.removeEventListener("pointermove", k), window.removeEventListener("pointerup", L);
    }), Fe(() => {
      a.value = u(e.value);
    });
    const w = { props: e, emit: i, currentIndex: a, root: l, track: o, handle: c, optionsCount: f, valueToIndex: u, positions: g, displayValue: b, get dragging() {
      return x;
    }, set dragging(p) {
      x = p;
    }, get pointerId() {
      ...
      N = p;
    }, clamp: y, clientXToIndex: d, selectIndex: _, onTrackClick: m, startDrag: A, onPointerMove: k, stopDrag: L, onArrow: v, ref: Q, computed: P, watch: Ye, onMounted: Fe, onBeforeUnmount: ki, CtrlLayout: _t };
    return Object.defineProperty(w, "__isScriptSetup", { enumerable: !1, value: !0 }), w;
  }
}, Qo = {
  class: "vue-lab__size",
  ref: "root"
}, Jo = ["onClick", "aria-label", "onKeydown"], el = ["aria-valuemax", "aria-valuenow", "aria-valuetext"], tl = { class: "vue-lab__size-value" };
function nl(s, n, t, e, i, a) {
  return R(), V(e.CtrlLayout, { name: "Size" }, {
    default: ve(() => [
      M(
        "div",
        Qo,
          ...
          M(
            ...
            [
              (R(!0), $(
                he,
                null,
                Se(t.options, (l, o) => (R(), $("div", {
                  key: o,
                  class: De(["vue-lab__size-tick", {
...
const Ii = /* @__PURE__ */ ie(Xo, [["render", nl], ["__scopeId", "data-v-96bfa191"], ["__file", "./index.vue"]]), il = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = P(() => ["vue-lab__boolean-tumbler", {
...
const Mi = /* @__PURE__ */ ie(il, [["render", sl], ["__file", "./index.vue"]]), al = {
  ...
  setup(s, { expose: n, emit: t }) {
    ...
    }, o = P(() => !!i.value && i.value !== ""), f = { emit: e, props: i, isFocused: a, handleTextInput: l, isValue: o, handleFocus: (u) => {
      a.value = u === "in";
...
const Li = /* @__PURE__ */ ie(al, [["render", ll], ["__scopeId", "data-v-3d8e17f8"], ["__file", "./index.vue"]]), cl = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = P(() => e.value || "linear-gradient(to right, #ff0000 0%, #ffff00 17%, #00ff00 33%, #00ffff 50%, #0000ff 67%, #ff00ff 83%, #ff0000 100%)"), o = { props: e, emit: i, bgColor: a, handleColorInput: (c) => {
...
const Di = /* @__PURE__ */ ie(cl, [["render", dl], ["__scopeId", "data-v-8e33fe98"], ["__file", "./index.vue"]]), pl = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, a = Q(null), l = Q(!1), o = Q(""), c = P(() => e.options.find((y) => y.id === e.value)?.name || null), f = P(() => o.value ? e.options.filter((y) => y?.name?.toLowerCase().includes(o?.value?.toLowerCase())) : e.options), u = () => {
      l.value = !l.value;
    }, g = () => {
      l.value = !1;
    }, N = { props: e, emit: i, dropdownActivator: a, isOpened: l, searchValue: o, selectedValue: c, filteredOptions: f, toggleOpened: u, close: g, handleItem: (y) => {
      i("input", y), g();
    }, handleSearch: (y) => {
      o.value = y;
    ...
    default: ve(() => [
      M(
        "div",
        {
          ...
          class: De(["vue-lab__dropdown-field", {
          ...
          M("div", fl, [
            ...
            e.filteredOptions.length ? (R(), $("ul", hl, [
              (R(!0), $(
                he,
                null,
                Se(e.filteredOptions, (o) => (R(), $("li", {
                  key: o.id,
                  class: De(["vue-lab__dropdown-list-item", {
...
const Bi = /* @__PURE__ */ ie(pl, [["render", bl], ["__scopeId", "data-v-b886953d"], ["__file", "./index.vue"]]), vl = {
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, f = { props: e, emit: i, componentsMap: {
      tags: Ci,
      size: Ii,
      boolean: Mi,
      text: Li,
      color: Di,
      list: Bi
    }, getValue: (u) => e.values?.[u], handleInput: ({ ctrl: u, value: g }) => i("input", { ctrl: u, value: g }), resetSettings: () => i("reset"), get Tags() {
      return Ci;
    }, get Size() {
      return Ii;
    }, get BooleanSwitcher() {
...
function Sl(s, n, t, e, i, a) {
  return R(), $("div", yl, [
    M("div", El, [
      ...
      M("div", wl, [
        ke(e.Button, { onClick: e.resetSettings }, {
          default: ve(() => [...n[0] || (n[0] = [
            ze(
              "Reset",
              -1
    ...
    M("div", xl, [
      (R(!0), $(
        he,
        null,
        Se(t.options, (l, o) => (R(), V(ct(e.componentsMap[l.ctrl]), {
          key: `ctrl-${l.ctrl}-${o}`,
          options: l.variants,
          title: l.title,
...
const ia = /* @__PURE__ */ ie(vl, [["render", Sl], ["__scopeId", "data-v-25497d41"], ["__file", "./index.vue"]]), Nl = {
  __name: "index",
  props: {
...
function kl(s, n, t, e, i, a) {
  return R(), $("div", Tl, [
    lt(s.$slots, "default", {}, void 0, !0)
  ]);
}
const di = /* @__PURE__ */ ie(Nl, [["render", kl], ["__scopeId", "data-v-036062d8"], ["__file", "./index.vue"]]), Ol = {
  __name: "index",
  props: {
    num: {
      type: Number,
...
const Ft = /* @__PURE__ */ ie(Ol, [["render", Rl], ["__scopeId", "data-v-a2d7e9c1"], ["__file", "./index.vue"]]), Cl = {
  __name: "Palette",
  props: {
  ...
  return R(), $("div", zl, [
    ...
    M("div", Kl, [
      (R(!0), $(
        he,
        null,
        Se(e.pallets, (l, o) => (R(), V(e.Palette, {
...
function Yl(s, n, t, e, i, a) {
  ...
  return R(), $("div", Wl, [
    ...
    t.isLast ? ne("v-if", !0) : (R(), V(e.Divider, { key: 2 }))
  ]);
}
const Xl = /* @__PURE__ */ ie(Hl, [["render", Yl], ["__scopeId", "data-v-d6fe0ccb"], ["__file", "./group.vue"]]), Ql = {
  ...
  setup(s, { expose: n }) {
    ...
    const t = s, e = Q(""), i = (u) => {
      ...
      const u = t.menu.map((y) => y.group), g = [...new Set(u)].filter((y) => y && y.length), b = (y) => !e.value || !e.value.length ? !0 : y.name.toLowerCase().includes(e.value.toLowerCase()), x = g.map((y) => {
        const d = t.menuGroupsDescription ? t.menuGroupsDescription[y] : null;
        return {
          name: y,
          description: d,
          items: t.menu.filter((_) => _.group === y).filter(b)
        };
      }), N = {
        name: null,
        description: t.menuGroupsDescription.Other,
        items: t.menu.filter((y) => !y.group || !y.group.length).filter(b)
      };
      return [...x, N];
    }), c = P(() => t.menu.some((u) => u.group && u.group.length)), f = { props: t, searchQuery: e, handleTextInput: i, pageDiscription: a, isEmptySearch: l, menuItems: o, isGroup: c, computed: P, ref: Q, Group: Xl, get generateKey() {
      return Xe;
    }, get LabIcon() {
      return ta;
    }, get Search() {
...
function rc(s, n, t, e, i, a) {
  return R(), $("div", Jl, [
    ...
    M("div", sc, [
      ke(e.Search, { onInput: e.handleTextInput })
    ]),
    M("div", ac, [
      e.isEmptySearch ? (R(), V(e.EmptyScreen, {
        key: 0,
        size: "lg"
      }, {
        default: ve(() => [...n[1] || (n[1] = [
        ...
        he,
        { key: 1 },
        Se(e.menuItems, (l, o) => (R(), $(
          he,
          null,
          [
            l.items?.length ? (R(), V(e.Group, {
              key: e.generateKey(l),
              option: l,
              isGroup: e.isGroup,
...
async function lc(s, n) {
  try {
    ...
    return console.log(t), console.warn(`⚠️ Config not found ${s}`), {};
  }
}
function cc(s) {
...
function $t() {
  if (Wi) return Mt;
  Wi = 1;
  var s = hi().InputScanner, n = sa().Token, t = _c().TokenStream, e = uc().WhitespacePattern, i = {
    START: "TK_START",
    RAW: "TK_RAW",
    EOF: "TK_EOF"
  }, a = function(l, o) {
  ...
  return a.prototype.tokenize = function() {
    ...
    for (var l, o = new n(i.START, ""), c = null, f = [], u = new t(); o.type !== i.EOF; ) {
      for (l = this._get_next_token(o, c); this._is_comment(l); )
        u.add(l), l = this._get_next_token(o, c);
      u.isEmpty() || (l.comments_before = u, u = new t()), l.parent = c, this._is_opening(l) ? (f.push(c), c = l) : c && this._is_closing(l, c) && (l.opened = c, c.closed = l, c = f.pop(), l.parent = c), l.previous = o, o.next = l, this.__tokens.add(l), o = l;
    }
...
function Lt() {
  if (Zi) return at;
  Zi = 1;
  var s = hi().InputScanner, n = $t().Tokenizer, t = $t().TOKEN, e = gi().Directives, i = aa(), a = Kt().Pattern, l = oa().TemplatablePattern;
  function o(v, w) {
  ...
  var c = {
    ...
    RAW: t.RAW,
    EOF: t.EOF
  }, f = new e(/\/\*/, /\*\//), u = /0[xX][0123456789abcdefABCDEF_]*n?|0[oO][01234567_]*n?|0[bB][01_]*n?|\d[\d_]*n|(?:\.\d[\d_]*|\d[\d_]*\.?[\d_]*)(?:[eE][+-]?[\d_]+)?/, g = /[0-9]/, b = /[^\d\.]/, x = ">>> === !== &&= ??= ||= << && >= ** != == <= >> || ?? |> < / - + > : & % ? ^ | *".split(" "), N = ">>>= ... >>= <<= === >>> !== **= &&= ??= ||= => ^= :: /= << <= == && -= >= >> != -- += ** || ?? ++ %= &= *= |= |> = ! ? > < : / ^ - + * & % ~ |";
  N = N.replace(/[-[\]{}()*+?.,\\^$|#]/g, "\\$&"), N = "\\?\\.(?!\\d) " + N, N = N.replace(/ /g, "|");
  var y = new RegExp(N), d = "continue,try,throw,return,var,let,const,if,switch,case,default,for,while,break,function,import,export".split(","), _ = d.concat(["do", "in", "of", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await", "from", "as", "class", "extends"]), m = new RegExp("^(?:" + _.join("|") + ")$"), A, k = function(v, w) {
    n.call(this, v, w), this._patterns.whitespace = this._patterns.whitespace.matching(
      /\u00A0\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff/.source,
      /\u2028\u2029/.source
    );
    var p = new a(this._input), T = new l(this._input).read_options(this._options);
    this.__patterns = {
      template: T,
  ...
  k.prototype = new n(), k.prototype._is_comment = function(v) {
    return v.type === c.COMMENT || v.type === c.BLOCK_COMMENT || v.type === c.UNKNOWN;
  }, k.prototype._is_opening = function(v) {
    return v.type === c.START_BLOCK || v.type === c.START_EXPR;
  }, k.prototype._is_closing = function(v, w) {
    return (v.type === c.END_BLOCK || v.type === c.END_EXPR) && w && (v.text === "]" && w.text === "[" || v.text === ")" && w.text === "(" || v.text === "}" && w.text === "{");
  }, k.prototype._reset = function() {
    A = !1;
  }, k.prototype._get_next_token = function(v, w) {
    var p = null;
    this._readWhitespace();
    var T = this._input.peek();
    return T === null ? this._create_token(c.EOF, "") : (p = p || this._read_non_javascript(T), p = p || this._read_string(T), p = p || this._read_pair(T, this._input.peek(1)), p = p || this._read_word(v), p = p || this._read_singles(T), p = p || this._read_comment(T), p = p || this._read_regexp(T, v), p = p || this._read_xml(T, v), p = p || this._read_punctuation(), p = p || this._create_token(c.UNKNOWN, this._input.next()), p);
  }, k.prototype._read_word = function(v) {
    var w;
    if (w = this.__patterns.identifier.read(), w !== "")
      return w = w.replace(i.allLineBreaks, `
`), !(v.type === c.DOT || v.type === c.RESERVED && (v.text === "set" || v.text === "get")) && m.test(w) ? (w === "in" || w === "of") && (v.type === c.WORD || v.type === c.STRING) ? this._create_token(c.OPERATOR, w) : this._create_token(c.RESERVED, w) : this._create_token(c.WORD, w);
    if (w = this.__patterns.number.read(), w !== "")
      return this._create_token(c.WORD, w);
  }, k.prototype._read_singles = function(v) {
    var w = null;
    return v === "(" || v === "[" ? w = this._create_token(c.START_EXPR, v) : v === ")" || v === "]" ? w = this._create_token(c.END_EXPR, v) : v === "{" ? w = this._create_token(c.START_BLOCK, v) : v === "}" ? w = this._create_token(c.END_BLOCK, v) : v === ";" ? w = this._create_token(c.SEMICOLON, v) : v === "." && b.test(this._input.peek(1)) ? w = this._create_token(c.DOT, v) : v === "," && (w = this._create_token(c.COMMA, v)), w && this._input.next(), w;
  }, k.prototype._read_pair = function(v, w) {
    var p = null;
    return v === "#" && w === "{" && (p = this._create_token(c.START_BLOCK, v + w)), p && (this._input.next(), this._input.next()), p;
  ...
  }, k.prototype._read_non_javascript = function(v) {
    var w = "";
    if (v === "#") {
      if (this._is_first_token() && (w = this.__patterns.shebang.read(), w))
        return this._create_token(c.UNKNOWN, w.trim() + `
`);
...
`);
      ...
      if (this._input.hasNext() && this._input.testChar(g)) {
        do
          v = this._input.next(), p += v;
        while (this._input.hasNext() && v !== "#" && v !== "=");
        return v === "#" || (this._input.peek() === "[" && this._input.peek(1) === "]" ? (p += "[]", this._input.next(), this._input.next()) : this._input.peek() === "{" && this._input.peek(1) === "}" && (p += "{}", this._input.next(), this._input.next())), this._create_token(c.WORD, p);
      }
      this._input.back();
      ...
      if (w = this.__patterns.html_comment_start.read(), w) {
        for (; this._input.hasNext() && !this._input.testChar(i.newline); )
          w += this._input.next();
        return A = !0, this._create_token(c.COMMENT, w);
      }
    } else if (A && v === "-" && (w = this.__patterns.html_comment_end.read(), w))
      return A = !1, this._create_token(c.COMMENT, w);
    return null;
  }, k.prototype._read_comment = function(v) {
    var w = null;
    if (v === "/") {
      var p = "";
      if (this._input.peek(1) === "*") {
        p = this.__patterns.block_comment.read();
        var T = f.get_directives(p);
        T && T.ignore === "start" && (p += f.readIgnored(this._input)), p = p.replace(i.allLineBreaks, `
`), w = this._create_token(c.BLOCK_COMMENT, p), w.directives = T;
      } else this._input.peek(1) === "/" && (p = this.__patterns.comment.read(), w = this._create_token(c.COMMENT, p));
    }
    return w;
  }, k.prototype._read_string = function(v) {
    if (v === "`" || v === "'" || v === '"') {
      var w = this._input.next();
      return this.has_char_escapes = !1, v === "`" ? w += this._read_string_recursive("`", !0, "${") : w += this._read_string_recursive(v), this.has_char_escapes && this._options.unescape_strings && (w = L(w)), this._input.peek() === v && (w += this._input.next()), w = w.replace(i.allLineBreaks, `
`), this._create_token(c.STRING, w);
    }
    return null;
  }, k.prototype._allow_regexp_or_xml = function(v) {
  ...
  }, k.prototype._read_regexp = function(v, w) {
    if (v === "/" && this._allow_regexp_or_xml(w)) {
      for (var p = this._input.next(), T = !1, r = !1; this._input.hasNext() && (T || r || this._input.peek() !== v) && !this._input.testChar(i.newline); )
        p += this._input.peek(), T ? T = !1 : (T = this._input.peek() === "\\", this._input.peek() === "[" ? r = !0 : this._input.peek() === "]" && (r = !1)), this._input.next();
      return this._input.peek() === v && (p += this._input.next(), p += this._input.read(i.identifier)), this._create_token(c.STRING, p);
    }
    return null;
  }, k.prototype._read_xml = function(v, w) {
    if (this._options.e4x && v === "<" && this._allow_regexp_or_xml(w)) {
      var p = "", T = this.__patterns.xml.read_match();
      if (T) {
        for (var r = T[2].replace(/^{\s+/, "{").replace(/\s+}$/, "}"), E = r.indexOf("{") === 0, S = 0; T; ) {
          var K = !!T[1], q = T[2], Z = !!T[T.length - 1] || q.slice(0, 8) === "![CDATA[";
          if (!Z && (q === r || E && q.replace(/^{\s+/, "{").replace(/\s+}$/, "}")) && (K ? --S : ++S), p += T[0], S <= 0)
            break;
          T = this.__patterns.xml.read_match();
        }
        return T || (p += this._input.match(/[\s\S]*/g)[0]), p = p.replace(i.allLineBreaks, `
`), this._create_token(c.STRING, p);
  ...
  function L(v) {
    for (var w = "", p = 0, T = new s(v), r = null; T.hasNext(); )
      if (r = T.match(/([\s]|[^\\]|\\\\)+/g), r && (w += r[0]), T.peek() === "\\") {
        if (T.next(), T.peek() === "x")
          r = T.match(/x([0-9A-Fa-f]{2})/g);
        else if (T.peek() === "u")
          r = T.match(/u([0-9A-Fa-f]{4})/g);
        else {
          w += "\\", T.hasNext() && (w += T.next());
          continue;
        }
        if (!r || (p = parseInt(r[1], 16), p > 126 && p <= 255 && r[0].indexOf("x") === 0))
          return v;
        if (p >= 0 && p < 32) {
          w += "\\" + r[0];
          continue;
        } else p === 34 || p === 39 || p === 92 ? w += "\\" + String.fromCharCode(p) : w += String.fromCharCode(p);
      }
    return w;
  }
  return k.prototype._read_string_recursive = function(v, w, p) {
    var T, r;
    ...
    for (var E = r.read(), S = ""; this._input.hasNext(); ) {
      if (S = this._input.next(), S === v || !w && i.newline.test(S)) {
        this._input.back();
        break;
      } else S === "\\" && this._input.hasNext() ? (T = this._input.peek(), T === "x" || T === "u" ? this.has_char_escapes = !0 : T === "\r" && this._input.peek(1) === `
` && this._input.next(), S += this._input.next()) : p && (p === "${" && S === "$" && this._input.peek() === "{" && (S += this._input.next()), p === S && (v === "`" ? S += this._read_string_recursive("}", w, "`") : S += this._read_string_recursive("`", w, "${"), this._input.hasNext() && (S += this._input.next())));
      S += r.read(), E += S;
    }
    return E;
  }, at.Tokenizer = k, at.TOKEN = c, at.positionable_operators = x.slice(), at.line_starters = d.slice(), at;
}
var Yi;
function dc() {
  if (Yi) return an;
  Yi = 1;
  var s = pi().Output, n = sa().Token, t = aa(), e = ra().Options, i = Lt().Tokenizer, a = Lt().line_starters, l = Lt().positionable_operators, o = Lt().TOKEN;
  function c(r, E) {
  ...
  function u(r) {
    for (var E = {}, S = 0; S < r.length; S++)
      E[r[S].replace(/-/g, "_")] = r[S];
    return E;
  }
  function g(r, E) {
    return r && r.type === o.RESERVED && r.text === E;
  }
  function b(r, E) {
    return r && r.type === o.RESERVED && c(r.text, E);
  }
  var x = ["case", "return", "do", "if", "throw", "else", "await", "break", "continue", "async"], N = ["before-newline", "after-newline", "preserve-newline"], y = u(N), d = [y.before_newline, y.preserve_newline], _ = {
  ...
  function m(r, E) {
    E.multiline_frame || E.mode === _.ForInitializer || E.mode === _.Conditional || r.remove_indent(E.start_line_index);
  }
  function A(r) {
    r = r.replace(t.allLineBreaks, `
`);
    for (var E = [], S = r.indexOf(`
`); S !== -1; )
      E.push(r.substring(0, S)), r = r.substring(S + 1), S = r.indexOf(`
`);
  ...
  function w(r, E) {
    for (var S = 0, K = r.length, q; S < K; S++)
      if (q = r[S], q && q.indexOf(E) !== 0)
        return !1;
    return !0;
  }
  function p(r, E) {
    E = E || {}, this._source_text = r || "", this._output = null, this._tokens = null, this._last_last_text = null, this._flags = null, this._previous_flags = null, this._flag_store = null, this._options = new e(E);
  }
  p.prototype.create_flags = function(r, E) {
    var S = 0;
    r && (S = r.indentation_level, !this._output.just_added_newline() && r.line_indent_level > S && (S = r.line_indent_level));
    var K = {
      mode: E,
      parent: r,
      ...
      indentation_level: S,
      alignment: 0,
      line_indent_level: r ? r.line_indent_level : S,
      start_line_index: this._output.get_line_number(),
      ternary_depth: 0
    };
    return K;
  }, p.prototype._reset = function(r) {
    var E = r.match(/^[\t ]*/)[0];
    this._last_last_text = "", this._output = new s(this._options, E), this._output.raw = this._options.test_output_raw, this._flag_store = [], this.set_mode(_.BlockStatement);
    var S = new i(r, this._options);
    return this._tokens = S.tokenize(), r;
  }, p.prototype.beautify = function() {
    if (this._options.disabled)
      return this._source_text;
    var r, E = this._reset(this._source_text), S = this._options.eol;
    this._options.eol === "auto" && (S = `
`, E && t.lineBreak.test(E || "") && (S = E.match(t.lineBreak)[0]));
    for (var K = this._tokens.next(); K; )
      this.handle_token(K), this._last_last_text = this._flags.last_token.text, this._flags.last_token = K, K = this._tokens.next();
    return r = this._output.get_code(S), r;
  }, p.prototype.handle_token = function(r, E) {
    r.type === o.START_EXPR ? this.handle_start_expr(r) : r.type === o.END_EXPR ? this.handle_end_expr(r) : r.type === o.START_BLOCK ? this.handle_start_block(r) : r.type === o.END_BLOCK ? this.handle_end_block(r) : r.type === o.WORD ? this.handle_word(r) : r.type === o.RESERVED ? this.handle_word(r) : r.type === o.SEMICOLON ? this.handle_semicolon(r) : r.type === o.STRING ? this.handle_string(r) : r.type === o.EQUALS ? this.handle_equals(r) : r.type === o.OPERATOR ? this.handle_operator(r) : r.type === o.COMMA ? this.handle_comma(r) : r.type === o.BLOCK_COMMENT ? this.handle_block_comment(r, E) : r.type === o.COMMENT ? this.handle_comment(r, E) : r.type === o.DOT ? this.handle_dot(r) : r.type === o.EOF ? this.handle_eof(r) : r.type === o.UNKNOWN ? this.handle_unknown(r, E) : this.handle_unknown(r, E);
  }, p.prototype.handle_whitespace_and_comments = function(r, E) {
    var S = r.newlines, K = this._options.keep_array_indentation && k(this._flags.mode);
    if (r.comments_before)
      for (var q = r.comments_before.next(); q; )
        this.handle_whitespace_and_comments(q, E), this.handle_token(q, E), q = r.comments_before.next();
    if (K)
      for (var Z = 0; Z < S; Z += 1)
  ...
  return p.prototype.allow_wrap_or_preserved_newline = function(r, E) {
    if (E = E === void 0 ? !1 : E, !this._output.just_added_newline()) {
      var S = this._options.preserve_newlines && r.newlines || E, K = c(this._flags.last_token.text, l) || c(r.text, l);
      if (K) {
        var q = c(this._flags.last_token.text, l) && c(this._options.operator_position, d) || c(r.text, l);
        S = S && q;
      }
      if (S)
        this.print_newline(!1, !0);
      else if (this._options.wrap_line_length) {
        if (b(this._flags.last_token, T))
          return;
        this._output.set_wrap_point();
      }
    }
  }, p.prototype.print_newline = function(r, E) {
    if (!E && this._flags.last_token.text !== ";" && this._flags.last_token.text !== "," && this._flags.last_token.text !== "=" && (this._flags.last_token.type !== o.OPERATOR || this._flags.last_token.text === "--" || this._flags.last_token.text === "++"))
      for (var S = this._tokens.peek(); this._flags.mode === _.Statement && !(this._flags.if_block && g(S, "else")) && !this._flags.do_block; )
        this.restore_mode();
    this._output.add_new_line(r) && (this._flags.multiline_frame = !0);
  }, p.prototype.print_token_line_indentation = function(r) {
    this._output.just_added_newline() && (this._options.keep_array_indentation && r.newlines && (r.text === "[" || k(this._flags.mode)) ? (this._output.current_line.set_indent(-1), this._output.current_line.push(r.whitespace_before), this._output.space_before_token = !1) : this._output.set_indent(this._flags.indentation_level, this._flags.alignment) && (this._flags.line_indent_level = this._flags.indentation_level));
  }, p.prototype.print_token = function(r) {
    if (this._output.raw) {
    ...
    if (this._options.comma_first && r.previous && r.previous.type === o.COMMA && this._output.just_added_newline() && this._output.previous_line.last() === ",") {
      ...
      this._output.previous_line.is_empty() && (this._output.previous_line.push(E), this._output.trim(!0), this._output.current_line.pop(), this._output.trim()), this.print_token_line_indentation(r), this._output.add_token(","), this._output.space_before_token = !0;
    }
  ...
  }, p.prototype.set_mode = function(r) {
  ...
  }, p.prototype.start_of_statement = function(r) {
    var E = !1;
    return E = E || b(this._flags.last_token, ["var", "let", "const"]) && r.type === o.WORD, E = E || g(this._flags.last_token, "do"), E = E || !(this._flags.parent.mode === _.ObjectLiteral && this._flags.mode === _.Statement) && b(this._flags.last_token, T) && !r.newlines, E = E || g(this._flags.last_token, "else") && !(g(r, "if") && !r.comments_before), E = E || this._flags.last_token.type === o.END_EXPR && (this._previous_flags.mode === _.ForInitializer || this._previous_flags.mode === _.Conditional), E = E || this._flags.last_token.type === o.WORD && this._flags.mode === _.BlockStatement && !this._flags.in_case && !(r.text === "--" || r.text === "++") && this._last_last_text !== "function" && r.type !== o.WORD && r.type !== o.RESERVED, E = E || this._flags.mode === _.ObjectLiteral && (this._flags.last_token.text === ":" && this._flags.ternary_depth === 0 || b(this._flags.last_token, ["get", "set"])), E ? (this.set_mode(_.Statement), this.indent(), this.handle_whitespace_and_comments(r, !0), this.start_of_object_property() || this.allow_wrap_or_preserved_newline(
      r,
      b(r, ["do", "for", "if", "while"])
    ), !0) : !1;
  }, p.prototype.handle_start_expr = function(r) {
    ...
    if (r.text === "[") {
      ...
      if (this._flags.last_token.type === o.RESERVED)
        ...
        if (this._options.space_after_named_function && S) {
          var K = this._tokens.peek(-4);
          b(S, ["async", "function"]) || S.text === "*" && b(K, ["async", "function"]) ? this._output.space_before_token = !0 : this._flags.mode === _.ObjectLiteral ? (S.text === "{" || S.text === "," || S.text === "*" && (K.text === "{" || K.text === ",")) && (this._output.space_before_token = !0) : this._flags.parent && this._flags.parent.class_start_block && (this._output.space_before_token = !0);
        }
      } else
    ...
    this._flags.last_token.text === ";" || this._flags.last_token.type === o.START_BLOCK ? this.print_newline() : (this._flags.last_token.type === o.END_EXPR || this._flags.last_token.type === o.START_EXPR || this._flags.last_token.type === o.END_BLOCK || this._flags.last_token.text === "." || this._flags.last_token.type === o.COMMA) && this.allow_wrap_or_preserved_newline(r, r.newlines), this.print_token(r), this.set_mode(E), this._options.space_in_paren && (this._output.space_before_token = !0), this.indent();
  }, p.prototype.handle_end_expr = function(r) {
    ...
    this.handle_whitespace_and_comments(r), this._flags.multiline_frame && this.allow_wrap_or_preserved_newline(
      r,
      r.text === "]" && k(this._flags.mode) && !this._options.keep_array_indentation
    ), this._options.space_in_paren && (this._flags.last_token.type === o.START_EXPR && !this._options.space_in_empty_paren ? (this._output.trim(), this._output.space_before_token = !1) : this._output.space_before_token = !0), this.deindent(), this.print_token(r), this.restore_mode(), m(this._output, this._previous_flags), this._flags.do_while && this._previous_flags.mode === _.Conditional && (this._previous_flags.mode = _.Expression, this._flags.do_block = !1, this._flags.do_while = !1);
  }, p.prototype.handle_start_block = function(r) {
    this.handle_whitespace_and_comments(r);
    var E = this._tokens.peek(), S = this._tokens.peek(1);
    this._flags.last_word === "switch" && this._flags.last_token.type === o.END_EXPR ? (this.set_mode(_.BlockStatement), this._flags.in_case_statement = !0) : this._flags.case_body ? this.set_mode(_.BlockStatement) : S && (c(S.text, [":", ","]) && c(E.type, [o.STRING, o.WORD, o.RESERVED]) || c(E.text, ["get", "set", "..."]) && c(S.type, [o.WORD, o.RESERVED])) ? c(this._last_last_text, ["class", "interface"]) && !c(S.text, [":", ","]) ? this.set_mode(_.BlockStatement) : this.set_mode(_.ObjectLiteral) : this._flags.last_token.type === o.OPERATOR && this._flags.last_token.text === "=>" ? this.set_mode(_.BlockStatement) : c(this._flags.last_token.type, [o.EQUALS, o.START_EXPR, o.COMMA, o.OPERATOR]) || b(this._flags.last_token, ["return", "throw", "import", "default"]) ? this.set_mode(_.ObjectLiteral) : this.set_mode(_.BlockStatement), this._flags.last_token && b(this._flags.last_token.previous, ["class", "extends"]) && (this._flags.class_start_block = !0);
    var K = !E.comments_before && E.text === "}", q = K && this._flags.last_word === "function" && this._flags.last_token.type === o.END_EXPR;
    if (this._options.brace_preserve_inline) {
      var Z = 0, I = null;
      this._flags.inline_frame = !0;
      do
        if (Z += 1, I = this._tokens.peek(Z - 1), I.newlines) {
          this._flags.inline_frame = !1;
          break;
        }
      while (I.type !== o.EOF && !(I.type === o.END_BLOCK && I.opened === r));
    }
    (this._options.brace_style === "expand" || this._options.brace_style === "none" && r.newlines) && !this._flags.inline_frame ? this._flags.last_token.type !== o.OPERATOR && (q || this._flags.last_token.type === o.EQUALS || b(this._flags.last_token, x) && this._flags.last_token.text !== "else") ? this._output.space_before_token = !0 : this.print_newline(!1, !0) : (k(this._previous_flags.mode) && (this._flags.last_token.type === o.START_EXPR || this._flags.last_token.type === o.COMMA) && ((this._flags.last_token.type === o.COMMA || this._options.space_in_paren) && (this._output.space_before_token = !0), (this._flags.last_token.type === o.COMMA || this._flags.last_token.type === o.START_EXPR && this._flags.inline_frame) && (this.allow_wrap_or_preserved_newline(r), this._previous_flags.multiline_frame = this._previous_flags.multiline_frame || this._flags.multiline_frame, this._flags.multiline_frame = !1)), this._flags.last_token.type !== o.OPERATOR && this._flags.last_token.type !== o.START_EXPR && (c(this._flags.last_token.type, [o.START_BLOCK, o.SEMICOLON]) && !this._flags.inline_frame ? this.print_newline() : this._output.space_before_token = !0)), this.print_token(r), this.indent(), !K && !(this._options.brace_preserve_inline && this._flags.inline_frame) && this.print_newline();
  }, p.prototype.handle_end_block = function(r) {
    for (this.handle_whitespace_and_comments(r); this._flags.mode === _.Statement; )
      this.restore_mode();
    var E = this._flags.last_token.type === o.START_BLOCK;
  ...
  }, p.prototype.handle_word = function(r) {
    if (r.type === o.RESERVED) {
      if (c(r.text, ["set", "get"]) && this._flags.mode !== _.ObjectLiteral)
        ...
        E.text === ":" && (r.type = o.WORD);
      }
    }
    if (this.start_of_statement(r) ? b(this._flags.last_token, ["var", "let", "const"]) && r.type === o.WORD && (this._flags.declaration_statement = !0) : r.newlines && !L(this._flags.mode) && (this._flags.last_token.type !== o.OPERATOR || this._flags.last_token.text === "--" || this._flags.last_token.text === "++") && this._flags.last_token.type !== o.EQUALS && (this._options.preserve_newlines || !b(this._flags.last_token, ["var", "let", "const", "set", "get"])) ? (this.handle_whitespace_and_comments(r), this.print_newline()) : this.handle_whitespace_and_comments(r), this._flags.do_block && !this._flags.do_while)
      if (g(r, "while")) {
    ...
    if ((this._flags.last_token.type === o.COMMA || this._flags.last_token.type === o.START_EXPR || this._flags.last_token.type === o.EQUALS || this._flags.last_token.type === o.OPERATOR) && (this.start_of_object_property() || this.allow_wrap_or_preserved_newline(r)), g(r, "function")) {
      (c(this._flags.last_token.text, ["}", ";"]) || this._output.just_added_newline() && !(c(this._flags.last_token.text, ["(", "[", "{", ":", "=", ","]) || this._flags.last_token.type === o.OPERATOR)) && !this._output.just_added_blankline() && !r.comments_before && (this.print_newline(), this.print_newline(!0)), this._flags.last_token.type === o.RESERVED || this._flags.last_token.type === o.WORD ? b(this._flags.last_token, ["get", "set", "new", "export"]) || b(this._flags.last_token, T) ? this._output.space_before_token = !0 : g(this._flags.last_token, "default") && this._last_last_text === "export" ? this._output.space_before_token = !0 : this._flags.last_token.text === "declare" ? this._output.space_before_token = !0 : this.print_newline() : this._flags.last_token.type === o.OPERATOR || this._flags.last_token.text === "=" ? this._output.space_before_token = !0 : !this._flags.multiline_frame && (L(this._flags.mode) || k(this._flags.mode)) || this.print_newline(), this.print_token(r), this._flags.last_word = r.text;
      return;
    }
    var S = "NONE";
    if (this._flags.last_token.type === o.END_BLOCK ? this._previous_flags.inline_frame ? S = "SPACE" : b(r, ["else", "catch", "finally", "from"]) ? this._options.brace_style === "expand" || this._options.brace_style === "end-expand" || this._options.brace_style === "none" && r.newlines ? S = "NEWLINE" : (S = "SPACE", this._output.space_before_token = !0) : S = "NEWLINE" : this._flags.last_token.type === o.SEMICOLON && this._flags.mode === _.BlockStatement ? S = "NEWLINE" : this._flags.last_token.type === o.SEMICOLON && L(this._flags.mode) ? S = "SPACE" : this._flags.last_token.type === o.STRING ? S = "NEWLINE" : this._flags.last_token.type === o.RESERVED || this._flags.last_token.type === o.WORD || this._flags.last_token.text === "*" && (c(this._last_last_text, ["function", "yield"]) || this._flags.mode === _.ObjectLiteral && c(this._last_last_text, ["{", ","])) ? S = "SPACE" : this._flags.last_token.type === o.START_BLOCK ? this._flags.inline_frame ? S = "SPACE" : S = "NEWLINE" : this._flags.last_token.type === o.END_EXPR && (this._output.space_before_token = !0, S = "NEWLINE"), b(r, a) && this._flags.last_token.text !== ")" && (this._flags.inline_frame || this._flags.last_token.text === "else" || this._flags.last_token.text === "export" ? S = "SPACE" : S = "NEWLINE"), b(r, ["else", "catch", "finally"]))
      if ((!(this._flags.last_token.type === o.END_BLOCK && this._previous_flags.mode === _.BlockStatement) || this._options.brace_style === "expand" || this._options.brace_style === "end-expand" || this._options.brace_style === "none" && r.newlines) && !this._flags.inline_frame)
        ...
        this._output.trim(!0);
        var K = this._output.current_line;
        K.last() !== "}" && this.print_newline(), this._output.space_before_token = !0;
      }
    else S === "NEWLINE" ? b(this._flags.last_token, x) ? this._output.space_before_token = !0 : this._flags.last_token.text === "declare" && b(r, ["var", "let", "const"]) ? this._output.space_before_token = !0 : this._flags.last_token.type !== o.END_EXPR ? (this._flags.last_token.type !== o.START_EXPR || !b(r, ["var", "let", "const"])) && this._flags.last_token.text !== ":" && (g(r, "if") && g(r.previous, "else") ? this._output.space_before_token = !0 : this.print_newline()) : b(r, a) && this._flags.last_token.text !== ")" && this.print_newline() : this._flags.multiline_frame && k(this._flags.mode) && this._flags.last_token.text === "," && this._last_last_text === "}" ? this.print_newline() : S === "SPACE" && (this._output.space_before_token = !0);
  ...
  }, p.prototype.handle_semicolon = function(r) {
    this.start_of_statement(r) ? this._output.space_before_token = !1 : this.handle_whitespace_and_comments(r);
    for (var E = this._tokens.peek(); this._flags.mode === _.Statement && !(this._flags.if_block && g(E, "else")) && !this._flags.do_block; )
      this.restore_mode();
    this._flags.import_block && (this._flags.import_block = !1), this.print_token(r);
  }, p.prototype.handle_string = function(r) {
  ...
  }, p.prototype.handle_equals = function(r) {
  ...
  }, p.prototype.handle_comma = function(r) {
    this.handle_whitespace_and_comments(r, !0), this.print_token(r), this._output.space_before_token = !0, this._flags.declaration_statement ? (L(this._flags.parent.mode) && (this._flags.declaration_assignment = !1), this._flags.declaration_assignment ? (this._flags.declaration_assignment = !1, this.print_newline(!1, !0)) : this._options.comma_first && this.allow_wrap_or_preserved_newline(r)) : this._flags.mode === _.ObjectLiteral || this._flags.mode === _.Statement && this._flags.parent.mode === _.ObjectLiteral ? (this._flags.mode === _.Statement && this.restore_mode(), this._flags.inline_frame || this.print_newline()) : this._options.comma_first && this.allow_wrap_or_preserved_newline(r);
  }, p.prototype.handle_operator = function(r) {
    var E = r.text === "*" && (b(this._flags.last_token, ["function", "yield"]) || c(this._flags.last_token.type, [o.START_BLOCK, o.COMMA, o.END_BLOCK, o.SEMICOLON])), S = c(r.text, ["-", "+"]) && (c(this._flags.last_token.type, [o.START_BLOCK, o.START_EXPR, o.EQUALS, o.OPERATOR]) || c(this._flags.last_token.text, a) || this._flags.last_token.text === ",");
    if (!this.start_of_statement(r)) {
      var K = !E;
      this.handle_whitespace_and_comments(r, K);
    }
    ...
    var q = !0, Z = !0, I = !1;
    if (r.text === ":" ? this._flags.ternary_depth === 0 ? q = !1 : (this._flags.ternary_depth -= 1, I = !0) : r.text === "?" && (this._flags.ternary_depth += 1), !S && !E && this._options.preserve_newlines && c(r.text, l)) {
      var O = r.text === ":", D = O && I, te = O && !I;
      switch (this._options.operator_position) {
        case y.before_newline:
          this._output.space_before_token = !te, this.print_token(r), (!O || D) && this.allow_wrap_or_preserved_newline(r), this._output.space_before_token = !0;
          return;
        case y.after_newline:
          this._output.space_before_token = !0, !O || D ? this._tokens.peek().newlines ? this.print_newline(!1, !0) : this.allow_wrap_or_preserved_newline(r) : this._output.space_before_token = !1, this.print_token(r), this._output.space_before_token = !0;
          return;
        case y.preserve_newline:
          te || this.allow_wrap_or_preserved_newline(r), q = !(this._output.just_added_newline() || te), this._output.space_before_token = q, this.print_token(r), this._output.space_before_token = !0;
          return;
      }
    }
    if (E) {
      ...
      Z = Y && c(Y.type, [o.WORD, o.RESERVED]);
    } else if (r.text === "...")
      this.allow_wrap_or_preserved_newline(r), q = this._flags.last_token.type === o.START_BLOCK, Z = !1;
    else if (c(r.text, ["--", "++", "!", "~"]) || S) {
      if ((this._flags.last_token.type === o.COMMA || this._flags.last_token.type === o.START_EXPR) && this.allow_wrap_or_preserved_newline(r), q = !1, Z = !1, r.newlines && (r.text === "--" || r.text === "++" || r.text === "~")) {
        var z = b(this._flags.last_token, x) && r.newlines;
        z && (this._previous_flags.if_block || this._previous_flags.else_block) && this.restore_mode(), this.print_newline(z, !0);
      }
      this._flags.last_token.text === ";" && L(this._flags.mode) && (q = !0), this._flags.last_token.type === o.RESERVED ? q = !0 : this._flags.last_token.type === o.END_EXPR ? q = !(this._flags.last_token.text === "]" && (r.text === "--" || r.text === "++")) : this._flags.last_token.type === o.OPERATOR && (q = c(r.text, ["--", "-", "++", "+"]) && c(this._flags.last_token.text, ["--", "-", "++", "+"]), c(r.text, ["+", "-"]) && c(this._flags.last_token.text, ["--", "++"]) && (Z = !0)), (this._flags.mode === _.BlockStatement && !this._flags.inline_frame || this._flags.mode === _.Statement) && (this._flags.last_token.text === "{" || this._flags.last_token.text === ";") && this.print_newline();
    }
    this._output.space_before_token = this._output.space_before_token || q, this.print_token(r), this._output.space_before_token = Z;
  }, p.prototype.handle_block_comment = function(r, E) {
    if (this._output.raw) {
      this._output.add_raw_token(r), r.directives && r.directives.preserve === "end" && (this._output.raw = this._options.test_output_raw);
      return;
    }
    if (r.directives) {
      this.print_newline(!1, E), this.print_token(r), r.directives.preserve === "start" && (this._output.raw = !0), this.print_newline(!1, !0);
      return;
    }
    if (!t.newline.test(r.text) && !r.newlines) {
      ...
      this.print_block_commment(r, E);
  }, p.prototype.print_block_commment = function(r, E) {
    var S = A(r.text), K, q = !1, Z = !1, I = r.whitespace_before, O = I.length;
    if (this.print_newline(!1, E), this.print_token_line_indentation(r), this._output.add_token(S[0]), this.print_newline(!1, E), S.length > 1) {
      for (S = S.slice(1), q = v(S, "*"), Z = w(S, I), q && (this._flags.alignment = 1), K = 0; K < S.length; K++)
        q ? (this.print_token_line_indentation(r), this._output.add_token(f(S[K]))) : Z && S[K] ? (this.print_token_line_indentation(r), this._output.add_token(S[K].substring(O))) : (this._output.current_line.set_indent(-1), this._output.add_token(S[K])), this.print_newline(!1, E);
      this._flags.alignment = 0;
    }
  }, p.prototype.handle_comment = function(r, E) {
    r.newlines ? this.print_newline(!1, E) : this._output.trim(!0), this._output.space_before_token = !0, this.print_token(r), this.print_newline(!1, E);
  }, p.prototype.handle_dot = function(r) {
  ...
  }, p.prototype.handle_unknown = function(r, E) {
    this.print_token(r), r.text[r.text.length - 1] === `
` && this.print_newline(!1, E);
  }, p.prototype.handle_eof = function(r) {
    for (; this._flags.mode === _.Statement; )
      this.restore_mode();
    this.handle_whitespace_and_comments(r);
  }, an.Beautifier = p, an;
...
function pc() {
  ...
  Xi = 1;
  var s = dc().Beautifier, n = ra().Options;
  function t(e, i) {
    var a = new s(e, i);
    return a.beautify();
  }
...
function fc() {
  if (Ji) return gn;
  Ji = 1;
  var s = la().Options, n = pi().Output, t = hi().InputScanner, e = gi().Directives, i = new e(/\/\*/, /\*\//), a = /\r\n|[\r\n]/, l = /\r\n|[\r\n]/g, o = /\s/, c = /(?:\s|\n)+/g, f = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, u = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
  function g(b, x) {
...
`);
    ...
    for (var y = 0, d = !1, _ = !1, m = !1, A = !1, k = !1, L = this._ch, v = !1, w, p, T; w = this._input.read(c), p = w !== "", T = L, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), L = this._ch, this._ch; )
      if (this._ch === "/" && this._input.peek() === "*") {
        this._output.add_new_line(), this._input.back();
        var r = this._input.read(f), E = i.get_directives(r);
        E && E.ignore === "start" && (r += i.readIgnored(this._input)), this.print_string(r), this.eatWhitespace(!0), this._output.add_new_line();
        ...
        S.match(/[ :]$/) && (S = this.eatString(": ").replace(/\s$/, ""), this.print_string(S), this._output.space_before_token = !0), S = S.replace(/\s$/, ""), y === 0 && S.indexOf(":") !== -1 && (_ = !0, this.indent());
      } else if (this._ch === "@")
        if (this.preserveSingleSpace(p), this._input.peek() === "{")
          ...
          K.match(/[ :]$/) && (K = this.eatString(": ").replace(/\s$/, ""), this.print_string(K), this._output.space_before_token = !0), K = K.replace(/\s$/, ""), y === 0 && K.indexOf(":") !== -1 ? (_ = !0, this.indent()) : K in this.NESTED_AT_RULE ? (this._nestedLevel += 1, K in this.CONDITIONAL_GROUP_RULE && (m = !0)) : y === 0 && !_ && (A = !0);
        }
      else if (this._ch === "#" && this._input.peek() === "{")
        this.preserveSingleSpace(p), this.print_string(this._ch + this.eatString("}"));
      else if (this._ch === "{")
        _ && (_ = !1, this.outdent()), A = !1, m ? (m = !1, d = this._indentLevel >= this._nestedLevel) : d = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && d && this._output.previous_line && this._output.previous_line.item(-1) !== "{" && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, this._options.brace_style === "expand" ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (T === "(" ? this._output.space_before_token = !1 : T !== "," && this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line();
      else if (this._ch === "}")
        this.outdent(), this._output.add_new_line(), T === "{" && this._output.trim(!0), _ && (this.outdent(), _ = !1), this.print_string(this._ch), d = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && this._input.peek() !== "}" && this._output.add_new_line(!0), this._input.peek() === ")" && (this._output.trim(!0), this._options.brace_style === "expand" && this._output.add_new_line(!0));
      else if (this._ch === ":") {
        ...
        (d || m) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !A && y === 0 ? (this.print_string(":"), _ || (_ = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
      } else if (this._ch === '"' || this._ch === "'") {
        var Z = T === '"' || T === "'";
        this.preserveSingleSpace(Z || p), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
      } else if (this._ch === ";")
        v = !1, y === 0 ? (_ && (this.outdent(), _ = !1), A = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
      else if (this._ch === "(")
        if (this._input.lookBack("url"))
          ...
          var I = !1;
          this._input.lookBack("with") && (I = !0), this.preserveSingleSpace(p || I), this.print_string(this._ch), _ && T === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), k = !0) : (this.eatWhitespace(), y++, this.indent());
        }
      else if (this._ch === ")")
        y && (y--, this.outdent()), k && this._input.peek() === ";" && this._options.selector_separator_newline && (k = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
      else if (this._ch === ",")
        this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!_ || k) && y === 0 && !A ? this._output.add_new_line() : this._output.space_before_token = !0;
      else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !_ && y === 0)
        ...
        var O = T === '"' || T === "'";
        this.preserveSingleSpace(O || p), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && v && this._output.add_new_line();
      }
    var D = this._output.get_code(x);
    return D;
  }, gn.Beautifier = g, gn;
}
var es;
function hc() {
  ...
  es = 1;
  var s = fc().Beautifier, n = la().Options;
  function t(e, i) {
    var a = new s(e, i);
    return a.beautify();
  }
...
function is() {
  if (ns) return Pt;
  ns = 1;
  var s = $t().Tokenizer, n = $t().TOKEN, t = gi().Directives, e = oa().TemplatablePattern, i = Kt().Pattern, a = {
    ...
    RAW: n.RAW,
    EOF: n.EOF
  }, l = new t(/<\!--/, /-->/), o = function(c, f) {
    s.call(this, c, f), this._current_tag_name = "";
    var u = new e(this._input).read_options(this._options), g = new i(this._input);
    if (this.__patterns = {
      word: u.until(/[\n\r\t <]/),
  ...
  return o.prototype = new s(), o.prototype._is_comment = function(c) {
    ...
    return c.type === a.TAG_OPEN;
  }, o.prototype._is_closing = function(c, f) {
    return c.type === a.TAG_CLOSE && f && ((c.text === ">" || c.text === "/>") && f.text[0] === "<" || c.text === "}}" && f.text[0] === "{" && f.text[1] === "{");
  }, o.prototype._reset = function() {
    this._current_tag_name = "";
  }, o.prototype._get_next_token = function(c, f) {
    var u = null;
    this._readWhitespace();
    var g = this._input.peek();
    return g === null ? this._create_token(a.EOF, "") : (u = u || this._read_open_handlebars(g, f), u = u || this._read_attribute(g, c, f), u = u || this._read_close(g, f), u = u || this._read_raw_content(g, c, f), u = u || this._read_content_word(g), u = u || this._read_comment_or_cdata(g), u = u || this._read_processing(g), u = u || this._read_open(g, f), u = u || this._create_token(a.UNKNOWN, this._input.next()), u);
  }, o.prototype._read_comment_or_cdata = function(c) {
    var f = null, u = null, g = null;
    if (c === "<") {
      var b = this._input.peek(1);
      b === "!" && (u = this.__patterns.comment.read(), u ? (g = l.get_directives(u), g && g.ignore === "start" && (u += l.readIgnored(this._input))) : u = this.__patterns.cdata.read()), u && (f = this._create_token(a.COMMENT, u), f.directives = g);
    }
    return f;
    ...
    if (c === "<") {
      var b = this._input.peek(1);
      (b === "!" || b === "?") && (u = this.__patterns.conditional_comment.read(), u = u || this.__patterns.processing.read()), u && (f = this._create_token(a.COMMENT, u), f.directives = g);
    }
    return f;
  }, o.prototype._read_open = function(c, f) {
    var u = null, g = null;
    return f || c === "<" && (u = this._input.next(), this._input.peek() === "/" && (u += this._input.next()), u += this.__patterns.element_name.read(), g = this._create_token(a.TAG_OPEN, u)), g;
  }, o.prototype._read_open_handlebars = function(c, f) {
    var u = null, g = null;
    return f || this._options.indent_handlebars && c === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (u = this.__patterns.handlebars_comment.read(), u = u || this.__patterns.handlebars.read(), g = this._create_token(a.COMMENT, u)) : (u = this.__patterns.handlebars_open.read(), g = this._create_token(a.TAG_OPEN, u))), g;
  }, o.prototype._read_close = function(c, f) {
    var u = null, g = null;
    return f && (f.text[0] === "<" && (c === ">" || c === "/" && this._input.peek(1) === ">") ? (u = this._input.next(), c === "/" && (u += this._input.next()), g = this._create_token(a.TAG_CLOSE, u)) : f.text[0] === "{" && c === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), g = this._create_token(a.TAG_CLOSE, "}}"))), g;
  }, o.prototype._read_attribute = function(c, f, u) {
    var g = null, b = "";
    if (u && u.text[0] === "<")
      if (c === "=")
        ...
        c === '"' ? x += this.__patterns.double_quote.read() : x += this.__patterns.single_quote.read(), g = this._create_token(a.VALUE, x);
      } else
        b = this.__patterns.attribute.read(), b && (f.type === a.EQUALS ? g = this._create_token(a.VALUE, b) : g = this._create_token(a.ATTRIBUTE, b));
    return g;
  ...
  }, o.prototype._read_raw_content = function(c, f, u) {
    var g = "";
    if (u && u.text[0] === "{")
      g = this.__patterns.handlebars_raw_close.read();
    else if (f.type === a.TAG_CLOSE && f.opened.text[0] === "<" && f.text[0] !== "/") {
      var b = f.opened.text.substr(1).toLowerCase();
      if (b === "script" || b === "style") {
        var x = this._read_comment_or_cdata(c);
        if (x)
          return x.type = a.TEXT, x;
        g = this._input.readUntil(new RegExp("</" + b + "[\\n\\r\\t ]*?>", "ig"));
      } else this._is_content_unformatted(b) && (g = this._input.readUntil(new RegExp("</" + b + "[\\n\\r\\t ]*?>", "ig")));
    }
    return g ? this._create_token(a.TEXT, g) : null;
  }, o.prototype._read_content_word = function(c) {
    var f = "";
    if (this._options.unformatted_content_delimiter && c === this._options.unformatted_content_delimiter[0] && (f = this.__patterns.unformatted_content_delimiter.read()), f || (f = this.__patterns.word.read()), f)
      return this._create_token(a.TEXT, f);
...
function gc() {
  if (ss) return bn;
  ss = 1;
  var s = ca().Options, n = pi().Output, t = is().Tokenizer, e = is().TOKEN, i = /\r\n|[\r\n]/, a = /\r\n|[\r\n]/g, l = function(d, _) {
  ...
  var o = function(d) {
    for (var _ = null, m = d.next; m.type !== e.EOF && d.closed !== m; ) {
      if (m.type === e.ATTRIBUTE && m.text === "type") {
        m.next && m.next.type === e.EQUALS && m.next.next && m.next.next.type === e.VALUE && (_ = m.next.next.text);
        break;
      }
      m = m.next;
    }
    ...
    var m = null, A = null;
    return _.closed ? (d === "script" ? m = "text/javascript" : d === "style" && (m = "text/css"), m = o(_) || m, m.search("text/css") > -1 ? A = "css" : m.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? A = "javascript" : m.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? A = "html" : m.search(/test\/null/) > -1 && (A = "null"), A) : null;
  };
  function f(d, _) {
  ...
  g.prototype.get_parser_token = function() {
  ...
  }, g.prototype._get_frame = function(d, _) {
    ...
    return m;
  }, g.prototype.try_pop = function(d, _) {
  ...
  function b(d, _, m, A) {
    this._source_text = d || "", _ = _ || {}, this._js_beautify = m, this._css_beautify = A, this._tag_stack = null;
    var k = new s(_, "html");
...
`);
    var m = d.match(/^[\t ]*/)[0], A = {
      text: "",
      type: ""
    }, k = new x(), L = new l(this._options, m), v = new t(d, this._options).tokenize();
    this._tag_stack = new g(L);
    for (var w = null, p = v.next(); p.type !== e.EOF; )
      p.type === e.TAG_OPEN || p.type === e.COMMENT ? (w = this._handle_tag_open(L, p, k, A, v), k = w) : p.type === e.ATTRIBUTE || p.type === e.EQUALS || p.type === e.VALUE || p.type === e.TEXT && !k.tag_complete ? w = this._handle_inside_tag(L, p, k, A) : p.type === e.TAG_CLOSE ? w = this._handle_tag_close(L, p, k) : p.type === e.TEXT ? w = this._handle_text(L, p, k) : L.add_raw_token(p), A = w, p = v.next();
    var T = L._output.get_code(_);
    return T;
  }, b.prototype._handle_tag_close = function(d, _, m) {
    var A = {
      text: _.text,
      type: _.type
    };
    return d.alignment_size = 0, m.tag_complete = !0, d.set_space_before_token(_.newlines || _.whitespace_before !== "", !0), m.is_unformatted ? d.add_raw_token(_) : (m.tag_start_char === "<" && (d.set_space_before_token(_.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && m.has_wrapped_attrs && d.print_newline(!1)), d.print_token(_)), m.indent_content && !(m.is_unformatted || m.is_content_unformatted) && (d.indent(), m.indent_content = !1), !m.is_inline_element && !(m.is_unformatted || m.is_content_unformatted) && d.set_wrap_point(), A;
  }, b.prototype._handle_inside_tag = function(d, _, m, A) {
    var k = m.has_wrapped_attrs, L = {
      text: _.text,
      type: _.type
    };
    return d.set_space_before_token(_.newlines || _.whitespace_before !== "", !0), m.is_unformatted ? d.add_raw_token(_) : m.tag_start_char === "{" && _.type === e.TEXT ? d.print_preserved_newlines(_) ? (_.newlines = 0, d.add_raw_token(_)) : d.print_token(_) : (_.type === e.ATTRIBUTE ? d.set_space_before_token(!0) : (_.type === e.EQUALS || _.type === e.VALUE && _.previous.type === e.EQUALS) && d.set_space_before_token(!1), _.type === e.ATTRIBUTE && m.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (d.traverse_whitespace(_), k = k || _.newlines !== 0), this._is_wrap_attributes_force && m.attr_count >= this._options.wrap_attributes_min_attrs && (A.type !== e.TAG_OPEN || // ie. second attribute and beyond
    this._is_wrap_attributes_force_expand_multiline) && (d.print_newline(!1), k = !0)), d.print_token(_), k = k || d.previous_token_wrapped(), m.has_wrapped_attrs = k), L;
  }, b.prototype._handle_text = function(d, _, m) {
    var A = {
      text: _.text,
      type: "TK_CONTENT"
    };
    return m.custom_beautifier_name ? this._print_custom_beatifier_text(d, _, m) : m.is_unformatted || m.is_content_unformatted ? d.add_raw_token(_) : (d.traverse_whitespace(_), d.print_token(_)), A;
  }, b.prototype._print_custom_beatifier_text = function(d, _, m) {
    var A = this;
    if (_.text !== "") {
      var k = _.text, L, v = 1, w = "", p = "";
      m.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? L = this._js_beautify : m.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? L = this._css_beautify : m.custom_beautifier_name === "html" && (L = function(q, Z) {
        var I = new b(q, Z, A._js_beautify, A._css_beautify);
        return I.beautify();
...
`;
          ...
          var K = _.whitespace_before;
          K && (k = k.replace(new RegExp(`
(` + K + ")?", "g"), `
`)), k = T + k.replace(/\n/g, `
` + T);
        }
      w && (k ? k = w + k + `
` + p : k = w + p), d.print_newline(!1), k && (_.text = k, _.whitespace_before = "", _.newlines = 0, d.add_raw_token(_), d.print_newline(!0));
    }
  }, b.prototype._handle_tag_open = function(d, _, m, A, k) {
    var L = this._get_tag_open_token(_);
    if ((m.is_unformatted || m.is_content_unformatted) && !m.is_empty_element && _.type === e.TAG_OPEN && !L.is_start_tag ? (d.add_raw_token(_), L.start_tag_token = this._tag_stack.try_pop(L.tag_name)) : (d.traverse_whitespace(_), this._set_tag_position(d, _, L, m, A), L.is_inline_element || d.set_wrap_point(), d.print_token(_)), L.is_start_tag && this._is_wrap_attributes_force) {
      var v = 0, w;
      do
        w = k.peek(v), w.type === e.ATTRIBUTE && (L.attr_count += 1), v += 1;
      while (w.type !== e.EOF && w.type !== e.TAG_CLOSE);
    }
    return (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (L.alignment_size = _.text.length + 1), !L.tag_complete && !L.is_unformatted && (d.alignment_size = L.alignment_size), L;
  };
  var x = function(d, _) {
...
`) === -1 || (m.is_inline_element || m.is_unformatted || d.print_newline(!1), this._calcluate_parent_multiline(d, m));
  ...
  var N = ["address", "article", "aside", "blockquote", "details", "div", "dl", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "main", "menu", "nav", "ol", "p", "pre", "section", "table", "ul"], y = ["a", "audio", "del", "ins", "map", "noscript", "video"];
  return b.prototype._do_optional_end_element = function(d) {
    ...
    if (!(d.is_empty_element || !d.is_start_tag || !d.parent)) {
      if (d.tag_name === "body")
        ...
        (!m || y.indexOf(m.tag_name) === -1) && (_ = _ || this._tag_stack.try_pop("p"));
...
function mc() {
  ...
  as = 1;
  var s = gc().Beautifier, n = ca().Options;
  function t(e, i, a, l) {
    var o = new s(e, i, a, l);
    return o.beautify();
  }
...
function _a() {
  ...
  function s(h) {
    ...
    }), Object.freeze(h), Object.getOwnPropertyNames(h).forEach((C) => {
      const U = h[C], J = typeof U;
      (J === "object" || J === "function") && !Object.isFrozen(U) && s(U);
    }), h;
  }
  class n {
    /**
  ...
  const i = "</span>", a = (h) => !!h.scope, l = (h, { prefix: C }) => {
  ...
  class f {
     ...
     */
    static _walk(C, U) {
      return typeof U == "string" ? C.addText(U) : U.children && (C.openNode(U), U.children.forEach((J) => this._walk(C, J)), C.closeNode(U)), C;
    }
    /**
     * @param {Node} node
     */
  ...
  class u extends f {
    ...
    __addSublanguage(C, U) {
      const J = C.root;
      U && (J.scope = `language:${U}`), this.add(J);
    }
    toHTML() {
  ...
  function y(...h) {
    return h.map((U) => g(U)).join("");
  }
  function d(h) {
    const C = h[h.length - 1];
    return typeof C == "object" && C.constructor === Object ? (h.splice(h.length - 1, 1), C) : {};
  }
  function _(...h) {
    return "(" + (d(h).capture ? "" : "?:") + h.map((J) => g(J)).join("|") + ")";
  }
  function m(h) {
  ...
  function L(h, { joinWith: C }) {
    ...
    return h.map((J) => {
      ...
      for (; be.length > 0; ) {
        ...
        H += be.substring(0, G.index), be = be.substring(G.index + G[0].length), G[0][0] === "\\" && G[1] ? H += "\\" + String(Number(G[1]) + me) : (H += G[0], G[0] === "(" && U++);
      }
      return H;
    }).map((J) => `(${J})`).join(C);
  }
  const v = /\b\B/, w = "[a-zA-Z]\\w*", p = "[a-zA-Z_]\\w*", T = "\\b\\d+(\\.\\d+)?", r = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", E = "\\b(0b[01]+)", S = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", K = (h = {}) => {
    const C = /^#![ ]*\//;
  ...
  function Ae(h, C) {
    h.input[h.index - 1] === "." && C.ignoreMatch();
  }
  function Ie(h, C) {
    h.className !== void 0 && (h.scope = h.className, delete h.className);
  }
  function Ne(h, C) {
    C && h.beginKeywords && (h.begin = "\\b(" + h.beginKeywords.split(" ").join("|") + ")(?!\\.)(?=\\b|\\s)", h.__beforeBegin = Ae, h.keywords = h.keywords || h.beginKeywords, delete h.beginKeywords, h.relevance === void 0 && (h.relevance = 0));
  }
  function Qe(h, C) {
    Array.isArray(h.illegal) && (h.illegal = _(...h.illegal));
  }
  function Je(h, C) {
    if (h.match) {
  ...
  const bt = (h, C) => {
    ...
    Object.keys(h).forEach((J) => {
      delete h[J];
    }), h.keywords = U.keywords, h.begin = y(U.beforeMatch, b(U.begin)), h.starts = {
      relevance: 0,
      contains: [
        Object.assign(U, { endsParent: !0 })
      ]
    }, h.relevance = 0, delete U.beforeMatch;
  }, vt = [
    "of",
    "and",
    "for",
  ...
  function yt(h, C, U = Gt) {
    const J = /* @__PURE__ */ Object.create(null);
    return typeof h == "string" ? me(U, h.split(" ")) : Array.isArray(h) ? me(U, h) : Object.keys(h).forEach(function(be) {
      Object.assign(
        J,
        yt(h[be], C, be)
      );
    ...
    function me(be, H) {
      C && (H = H.map((G) => G.toLowerCase())), H.forEach(function(G) {
        const X = G.split("|");
        J[X[0]] = [be, dt(X[0], X[1])];
      });
    }
  ...
  const Et = {}, Ke = (h) => {
    ...
    console.log(`WARN: ${h}`, ...C);
  }, Me = (h, C) => {
    Et[`${h}/${C}`] || (console.log(`Deprecated as of ${h}. ${C}`), Et[`${h}/${C}`] = !0);
  }, it = new Error();
  function wt(h, C, { key: U }) {
    let J = 0;
    const me = h[U], be = {}, H = {};
    for (let G = 1; G <= C.length; G++)
      H[G + J] = me[G], be[G + J] = !0, J += m(C[G - 1]);
    h[U] = H, h[U]._emit = be, h[U]._multi = !0;
  }
  function xt(h) {
    if (Array.isArray(h.begin)) {
      ...
      wt(h, h.begin, { key: "beginScope" }), h.begin = L(h.begin, { joinWith: "" });
    }
  }
  function pt(h) {
    if (Array.isArray(h.end)) {
      ...
      wt(h, h.end, { key: "endScope" }), h.end = L(h.end, { joinWith: "" });
    }
  }
  function Ht(h) {
  ...
  function St(h) {
    Ht(h), typeof h.beginScope == "string" && (h.beginScope = { _wrap: h.beginScope }), typeof h.endScope == "string" && (h.endScope = { _wrap: h.endScope }), xt(h), pt(h);
  }
  function Wt(h) {
    function C(H, G) {
      return new RegExp(
        g(H),
        "m" + (h.case_insensitive ? "i" : "") + (h.unicodeRegex ? "u" : "") + (G ? "g" : "")
      );
    }
    class U {
      constructor() {
      ...
      // @ts-ignore
      addRule(G, X) {
        X.position = this.position++, this.matchIndexes[this.matchAt] = X, this.regexes.push([X, G]), this.matchAt += m(G) + 1;
      }
      compile() {
        this.regexes.length === 0 && (this.exec = () => null);
        const G = this.regexes.map((X) => X[1]);
        this.matcherRe = C(L(G, { joinWith: "|" }), !0), this.lastIndex = 0;
      }
      /** @param {string} s */
      exec(G) {
        ...
        if (!X)
          return null;
        const Te = X.findIndex((ht, Yt) => Yt > 0 && ht !== void 0), Ee = this.matchIndexes[Te];
        return X.splice(0, Te), Object.assign(X, Ee);
      }
    }
    class J {
      constructor() {
      ...
      getMatcher(G) {
        ...
        const X = new U();
        return this.rules.slice(G).forEach(([Te, Ee]) => X.addRule(Te, Ee)), X.compile(), this.multiRegexes[G] = X, X;
      }
      ...
      exec(G) {
        ...
        if (this.resumingScanAtSamePosition() && !(Te && Te.index === this.lastIndex)) {
          ...
          Ee.lastIndex = this.lastIndex + 1, Te = Ee.exec(G);
        }
    ...
    function me(H) {
      const G = new J();
      return H.contains.forEach((X) => G.addRule(X.begin, { rule: X, type: "begin" })), H.terminatorEnd && G.addRule(H.terminatorEnd, { type: "end" }), H.illegal && G.addRule(H.illegal, { type: "illegal" }), G;
    }
    function be(H, G) {
      const X = (
        /** @type CompiledMode */
      ...
      [
        ...
        St,
        bt
      ].forEach((Ee) => Ee(H, G)), h.compilerExtensions.forEach((Ee) => Ee(H, G)), H.__beforeBegin = null, [
        Ne,
        ...
        ut
      ].forEach((Ee) => Ee(H, G)), H.isCompiled = !0;
      let Te = null;
      return typeof H.keywords == "object" && H.keywords.$pattern && (H.keywords = Object.assign({}, H.keywords), Te = H.keywords.$pattern, delete H.keywords.$pattern), Te = Te || /\w+/, H.keywords && (H.keywords = yt(H.keywords, h.case_insensitive)), X.keywordPatternRe = C(Te, !0), G && (H.begin || (H.begin = /\B|\b/), X.beginRe = C(X.begin), !H.end && !H.endsWithParent && (H.end = /\B|\b/), H.end && (X.endRe = C(X.end)), X.terminatorEnd = g(X.end) || "", H.endsWithParent && G.terminatorEnd && (X.terminatorEnd += (H.end ? "|" : "") + G.terminatorEnd)), H.illegal && (X.illegalRe = C(
        /** @type {RegExp | string} */
        H.illegal
      )), H.contains || (H.contains = []), H.contains = [].concat(...H.contains.map(function(Ee) {
        return jt(Ee === "self" ? H : Ee);
      })), H.contains.forEach(function(Ee) {
        be(
          /** @type Mode */
          Ee,
          X
        );
      }), H.starts && be(H.starts, G), X.matcher = me(X), X;
    }
    if (h.compilerExtensions || (h.compilerExtensions = []), h.contains && h.contains.includes("self"))
      throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");
    return h.classNameAliases = e(h.classNameAliases || {}), be(
      /** @type Mode */
      h
    );
  }
  function Nt(h) {
    return h ? h.endsWithParent || Nt(h.starts) : !1;
  }
  function jt(h) {
    return h.variants && !h.cachedVariants && (h.cachedVariants = h.variants.map(function(C) {
      return e(h, { variants: null }, C);
    })), h.cachedVariants ? h.cachedVariants : Nt(h) ? e(h, { starts: h.starts ? e(h.starts) : null }) : Object.isFrozen(h) ? e(h) : h;
  }
  var Vt = "11.11.1";
  ...
  const ft = t, Tt = e, le = /* @__PURE__ */ Symbol("nomatch"), st = 7, qe = function(h) {
    const C = /* @__PURE__ */ Object.create(null), U = /* @__PURE__ */ Object.create(null), J = [];
    let me = !0;
    const be = "Could not find the language '{}', did you forget to load/include a language module?", H = { disableAutodetect: !0, name: "Plain text", contains: [] };
    let G = {
    ...
    function Te(B) {
      ...
      const ae = G.languageDetectRe.exec(j);
      if (ae) {
        const de = We(ae[1]);
        return de || (et(be.replace("{}", ae[1])), et("Falling back to no-highlight mode for this block.", B)), de ? ae[1] : "no-highlight";
      }
      return j.split(/\s+/).find((de) => X(de) || We(de));
    }
    function Ee(B, j, ae) {
      let de = "", xe = "";
      typeof j == "object" ? (de = B, ae = j.ignoreIllegals, xe = j.language) : (Me("10.7.0", "highlight(lang, code, ...args) has been deprecated."), Me("10.7.0", `Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`), xe = B, de = j), ae === void 0 && (ae = !0);
      const Pe = {
        code: de,
        language: xe
      };
      Ot("before:highlight", Pe);
      const je = Pe.result ? Pe.result : ht(Pe.language, Pe.code, ae);
      return je.code = Pe.code, Ot("after:highlight", je), je;
    }
    function ht(B, j, ae, de) {
      ...
      function je() {
        ...
        let W = ee.keywordPatternRe.exec(pe), se = "";
        for (; W; ) {
          se += pe.substring(F, W.index);
          const ce = $e.case_insensitive ? W[0].toLowerCase() : W[0], Re = Pe(ee, ce);
          if (Re) {
            const [Ge, Aa] = Re;
            if (Oe.addText(se), se = "", xe[ce] = (xe[ce] || 0) + 1, xe[ce] <= st && (Ct += Aa), Ge.startsWith("_"))
              se += W[0];
            else {
              const Ra = $e.classNameAliases[Ge] || Ge;
              Ue(W[0], Ra);
            }
          } else
            se += W[0];
          F = ee.keywordPatternRe.lastIndex, W = ee.keywordPatternRe.exec(pe);
        }
        se += pe.substring(F), Oe.addText(se);
      }
      function At() {
        if (pe === "") return;
        let F = null;
        if (typeof ee.subLanguage == "string") {
          ...
          F = ht(ee.subLanguage, pe, !0, Si[ee.subLanguage]), Si[ee.subLanguage] = /** @type {CompiledMode} */
          F._top;
        } else
          F = Xt(pe, ee.subLanguage.length ? ee.subLanguage : null);
        ee.relevance > 0 && (Ct += F.relevance), Oe.__addSublanguage(F._emitter, F.language);
      }
      function Le() {
        ee.subLanguage != null ? At() : je(), pe = "";
      }
      function Ue(F, W) {
        F !== "" && (Oe.startScope(W), Oe.addText(F), Oe.endScope());
      }
      function yi(F, W) {
        let se = 1;
        const ce = W.length - 1;
        for (; se <= ce; ) {
          ...
          const Re = $e.classNameAliases[F[se]] || F[se], Ge = W[se];
          Re ? Ue(Ge, Re) : (pe = Ge, je(), pe = ""), se++;
        }
      }
      function Ei(F, W) {
        return F.scope && typeof F.scope == "string" && Oe.openNode($e.classNameAliases[F.scope] || F.scope), F.beginScope && (F.beginScope._wrap ? (Ue(pe, $e.classNameAliases[F.beginScope._wrap] || F.beginScope._wrap), pe = "") : F.beginScope._multi && (yi(F.beginScope, W), pe = "")), ee = Object.create(F, { parent: { value: ee } }), ee;
      }
      function wi(F, W, se) {
        let ce = A(F.endRe, se);
        if (ce) {
          if (F["on:end"]) {
            const Re = new n(F);
            F["on:end"](W, Re), Re.isMatchIgnored && (ce = !1);
          }
          if (ce) {
        ...
        if (F.endsWithParent)
          return wi(F.parent, W, se);
      }
      function Sa(F) {
        return ee.matcher.regexIndex === 0 ? (pe += F[0], 1) : (tn = !0, 0);
      }
      function Na(F) {
        const W = F[0], se = F.rule, ce = new n(se), Re = [se.__beforeBegin, se["on:begin"]];
        for (const Ge of Re)
          if (Ge && (Ge(F, ce), ce.isMatchIgnored))
            return Sa(W);
        return se.skip ? pe += W : (se.excludeBegin && (pe += W), Le(), !se.returnBegin && !se.excludeBegin && (pe = W)), Ei(se, F), se.returnBegin ? 0 : W.length;
      }
      function Ta(F) {
        const W = F[0], se = j.substring(F.index), ce = wi(ee, F, se);
        if (!ce)
          return le;
        const Re = ee;
        ee.endScope && ee.endScope._wrap ? (Le(), Ue(W, ee.endScope._wrap)) : ee.endScope && ee.endScope._multi ? (Le(), yi(ee.endScope, F)) : Re.skip ? pe += W : (Re.returnEnd || Re.excludeEnd || (pe += W), Le(), Re.excludeEnd && (pe = W));
        do
          ee.scope && Oe.closeNode(), !ee.skip && !ee.subLanguage && (Ct += ee.relevance), ee = ee.parent;
        while (ee !== ce.parent);
        return ce.starts && Ei(ce.starts, F), Re.returnEnd ? 0 : W.length;
      }
      function ka() {
        const F = [];
        for (let W = ee; W !== $e; W = W.parent)
          W.scope && F.unshift(W.scope);
        F.forEach((W) => Oe.openNode(W));
      }
      let Rt = {};
      function xi(F, W) {
        const se = W && W[0];
        ...
        if (Rt.type === "begin" && W.type === "end" && Rt.index === W.index && se === "") {
          if (pe += j.slice(W.index, W.index + 1), !me) {
        ...
        if (W.type === "illegal" && !ae) {
          const ce = new Error('Illegal lexeme "' + se + '" for mode "' + (ee.scope || "<unnamed>") + '"');
          throw ce.mode = ee, ce;
        } else if (W.type === "end") {
          const ce = Ta(W);
          if (ce !== le)
...
`, 1;
        ...
        return pe += se, se.length;
      }
      const $e = We(B);
      if (!$e)
        throw Ke(be.replace("{}", B)), new Error('Unknown language: "' + B + '"');
      const Oa = Wt($e);
      let Jt = "", ee = de || Oa;
      const Si = {}, Oe = new G.__emitter(G);
      ka();
      let pe = "", Ct = 0, tt = 0, en = 0, tn = !1;
      try {
        if ($e.__emitTokens)
          $e.__emitTokens(j, Oe);
        else {
          for (ee.matcher.considerAll(); ; ) {
            en++, tn ? tn = !1 : ee.matcher.considerAll(), ee.matcher.lastIndex = tt;
            const F = ee.matcher.exec(j);
            if (!F) break;
            const W = j.substring(tt, F.index), se = xi(W, F);
            tt = F.index + se;
          }
          xi(j.substring(tt));
        }
    ...
    function Xt(B, j) {
      ...
      const ae = Yt(B), de = j.filter(We).filter(vi).map(
        (Le) => ht(Le, B, !1)
      );
      de.unshift(ae);
      const xe = de.sort((Le, Ue) => {
    ...
    function pa(B, j, ae) {
      const de = j && U[j] || ae;
      B.classList.add("hljs"), B.classList.add(`language-${de}`);
    }
    function Qt(B) {
      let j = null;
      const ae = Te(B);
      ...
      j = B;
      const de = j.textContent, xe = ae ? Ee(de, { language: ae, ignoreIllegals: !0 }) : Xt(de);
      B.innerHTML = xe.value, B.dataset.highlighted = "yes", pa(B, ae, xe.language), B.result = {
        language: xe.language,
        // TODO: remove with version 11.0
        re: xe.relevance,
        relevance: xe.relevance
      }, xe.secondBest && (B.secondBest = {
        language: xe.secondBest.language,
        relevance: xe.secondBest.relevance
      }), Ot("after:highlightElement", { el: B, result: xe, text: de });
    }
    function fa(B) {
      G = Tt(G, B);
    }
    const ha = () => {
      kt(), Me("10.6.0", "initHighlighting() deprecated.  Use highlightAll() now.");
    };
    function ga() {
      kt(), Me("10.6.0", "initHighlightingOnLoad() deprecated.  Use highlightAll() now.");
    }
    let mi = !1;
    function kt() {
      function B() {
      ...
      document.querySelectorAll(G.cssSelector).forEach(Qt);
    }
    function ma(B, j) {
      let ae = null;
      try {
        ...
        if (Ke("Language definition for '{}' could not be registered.".replace("{}", B)), me)
          Ke(de);
        else
          throw de;
        ae = H;
      }
      ae.name || (ae.name = B), C[B] = ae, ae.rawDefinition = j.bind(null, h), ae.aliases && bi(ae.aliases, { languageName: B });
    }
    function ba(B) {
      delete C[B];
...
function yc() {
  ...
  function s(n) {
    ...
    }), c = n.inherit(n.APOS_STRING_MODE, { className: "string" }), f = n.inherit(n.QUOTE_STRING_MODE, { className: "string" }), u = {
      endsWithParent: !0,
      illegal: /</,
      relevance: 0,
      contains: [
...
function Sc() {
  ...
  function s(n) {
    const t = [
      ...
      built_in: t,
      literal: i
    }, c = n.inherit(n.TITLE_MODE, { begin: "[a-zA-Z](\\.?\\w)*" }), f = {
      className: "number",
      variants: [
        { begin: "\\b(0b[01']+)" },
    ...
    }, k = n.IDENT_RE + "(<" + n.IDENT_RE + "(\\s*,\\s*" + n.IDENT_RE + ")*>)?(\\[\\])?", L = {
...
function Nc() {
  ...
  const s = (f) => ({
    ...
    BLOCK_COMMENT: f.C_BLOCK_COMMENT_MODE,
    HEXCOLOR: {
      scope: "number",
    ...
    CSS_NUMBER_MODE: {
      scope: "number",
      begin: f.NUMBER_RE + "(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?",
      relevance: 0
    },
    CSS_VARIABLE: {
      className: "attr",
  ...
  function c(f) {
    const u = f.regex, g = s(f), b = { begin: /-(webkit|moz|ms|o)-(?=[a-z])/ }, x = "and or not only", N = /@-?\w[\w]*(-\w+)*/, y = "[a-zA-Z-][a-zA-Z0-9_-]*", d = [
      f.APOS_STRING_MODE,
      f.QUOTE_STRING_MODE
    ];
    return {
...
function Tc() {
  ...
  function s(n) {
    ...
    }, b = n.inherit(u, { contains: [] }), x = n.inherit(g, { contains: [] });
    u.contains.push(x), g.contains.push(b);
    let N = [
      e,
      f
    ];
    return [
      ...
      m.contains = m.contains.concat(N);
    }), N = N.concat(u, g), {
      name: "Markdown",
      aliases: [
        "md",
...
function Oc() {
  ...
  function s(n) {
    ...
    return u.unshift(f), {
      ...
      keywords: o,
      illegal: /\/\*/,
      contains: [n.SHEBANG({ binary: "ruby" })].concat(E).concat(u).concat(w)
    };
  }
  return An = s, An;
}
...
function Ic() {
  ...
  function i(l, o, c) {
    return c === -1 ? "" : l.replace(o, (f) => i(l, o, c - 1));
  }
  function a(l) {
    const o = l.regex, c = "[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*", f = c + i("(?:<" + c + "~~~(?:\\s*,\\s*" + c + "~~~)*>)?", /~~~/g, 2), N = {
      keyword: [
        "synchronized",
        "abstract",
        "private",
...
function Mc() {
  ...
  function c(f) {
    const u = f.regex, g = (_e, { after: re }) => {
      const we = "</" + _e[0].slice(1);
      return _e.input.indexOf(we, re) !== -1;
    }, b = s, x = {
      begin: "<>",
      end: "</>"
    }, N = /<[A-Za-z0-9\\._:-]+\s*\/>/, y = {
      ...
      isTrulyOpeningTag: (_e, re) => {
        const we = _e[0].length + _e.index, fe = _e.input[we];
        if (
        ...
        fe === ">" && (g(_e, { after: we }) || re.ignoreMatch());
        let Ae;
        const Ie = _e.input.substring(we);
        if (Ae = Ie.match(/^\s*=/)) {
          re.ignoreMatch();
          return;
        }
      ...
      built_in: o,
      "variable.language": l
    }, _ = "[0-9](_?[0-9])*", m = `\\.(${_})`, A = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*", k = {
      className: "number",
      variants: [
        // DecimalLiteral
        { begin: `(\\b(${A})((${m})|\\.)?|(${m}))[eE][+-]?(${_})\\b` },
        { begin: `\\b(${A})\\b((${m})\\b|\\.)?|(${m})\\b` },
    ...
    const K = [].concat(E, L.contains), q = K.concat([
    ...
    return {
      ...
      contains: [
        ...
        },
        {
          ...
          contains: [
            Z,
            f.inherit(f.TITLE_MODE, { begin: b, className: "title.function" })
          ]
        },
...
function Bc() {
  ...
  function f(u) {
    const g = s(u), b = c, x = "and or not only", N = "[\\w-]+", y = "(" + N + "|@\\{" + N + "\\})", d = [], _ = [], m = function(K) {
      return {
...
function $c() {
  ...
  function s(n) {
    ...
    return l.contains = y, o.contains = y, {
      name: "Perl",
      aliases: [
        "pl",
        "pm"
...
function Fc() {
  ...
  function s(n) {
    const t = n.regex, e = /(?![A-Za-z0-9])(?![$])/, i = t.concat(
    ...
    }, u = n.inherit(n.APOS_STRING_MODE, { illegal: null }), g = n.inherit(n.QUOTE_STRING_MODE, {
      illegal: null,
      ...
      contains: n.QUOTE_STRING_MODE.contains.concat(f),
      "on:begin": (Z, I) => {
        I.data._beginMatch = Z[1] || Z[2];
      },
      "on:end": (Z, I) => {
        I.data._beginMatch !== Z[1] && I.ignoreMatch();
      }
      ...
      literal: ((Z) => {
        const I = [];
        return Z.forEach((O) => {
          I.push(O), O.toLowerCase() === O ? I.push(O.toUpperCase()) : I.push(O.toLowerCase());
        }), I;
      })(_),
      built_in: A
    }, v = (Z) => Z.map((I) => I.replace(/\|\d+$/, "")), w = { variants: [
      {
        match: [
          /new/,
          t.concat(N, "+"),
          // to prevent built ins from being confused as the class constructor call
          t.concat("(?!", v(A).join("\\b|"), "\\b)"),
          a
        ],
        scope: {
          1: "keyword",
      ...
      match: [
        ...
        t.concat("(?!fn\\b|function\\b|", v(m).join("\\b|"), "|", v(A).join("\\b|"), "\\b)"),
        i,
        t.concat(N, "*"),
        t.lookahead(/(?=\()/)
      ],
...
function qc() {
  ...
  function s(n) {
    ...
    }, x = "[0-9](_?[0-9])*", N = `(\\b(${x}))?\\.(${x})|\\b(${x})\\.`, y = `\\b|${i.join("|")}`, d = {
      className: "number",
      relevance: 0,
      variants: [
...
function Vc() {
  ...
  function c(f) {
    const u = s(f), g = l, b = a, x = "@[a-z-]+", N = "and or not only", d = {
      className: "variable",
...
function Yc() {
  ...
  function s(n) {
    ...
    function A(v) {
      return t.concat(
        /\b/,
        t.either(...v.map((w) => w.replace(/\s+/, "\\s+"))),
        /\b/
      );
    }
    const k = {
    ...
    function L(v, {
      ...
      const T = p;
      return w = w || [], v.map((r) => r.match(/\|\d+$/) || w.includes(r) ? r : T(r) ? `${r}|0` : r);
    }
    return {
      name: "SQL",
      case_insensitive: !0,
...
function Xc() {
  ...
  function t(...p) {
    return p.map((r) => s(r)).join("");
  }
  function e(p) {
    const T = p[p.length - 1];
    return typeof T == "object" && T.constructor === Object ? (p.splice(p.length - 1, 1), T) : {};
  }
  function i(...p) {
    return "(" + (e(p).capture ? "" : "?:") + p.map((E) => s(E)).join("|") + ")";
  }
  const a = (p) => t(
    /\b/,
    p,
  ...
  function w(p) {
    const T = {
      ...
      match: t(/\./, i(...f)),
      relevance: 0
    }, q = f.filter((le) => typeof le == "string").concat(["_|0"]), Z = f.filter((le) => typeof le != "string").concat(c).map(a), I = { variants: [
      {
        className: "keyword",
        match: i(...Z, ...o)
      }
      ...
      contains: [
        {
          ...
          className: "type",
          match: t(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, m, "+")
        },
        {
          // Type identifier
          className: "type",
...
function Qc() {
  ...
  function s(n) {
    ...
    return m.pop(), m.push(c), N.contains = m, {
      name: "YAML",
      case_insensitive: !0,
      aliases: ["yml"],
      contains: _
...
function Jc() {
  ...
  function c(u) {
    const g = u.regex, b = (re, { after: we }) => {
      const fe = "</" + re[0].slice(1);
      return re.input.indexOf(fe, we) !== -1;
    }, x = s, N = {
      begin: "<>",
      end: "</>"
    }, y = /<[A-Za-z0-9\\._:-]+\s*\/>/, d = {
       ...
       * @param {CallbackResponse} response
       */
      isTrulyOpeningTag: (re, we) => {
        const fe = re[0].length + re.index, Ae = re.input[fe];
        if (
          // HTML should not include another raw `<` inside a tag
          // nested type?
          // `<Array<Array<number>>`, etc.
        ...
        Ae === ">" && (b(re, { after: fe }) || we.ignoreMatch());
        let Ie;
        const Ne = re.input.substring(fe);
        if (Ie = Ne.match(/^\s*=/)) {
          we.ignoreMatch();
          return;
        }
        if ((Ie = Ne.match(/^\s+extends\s+/)) && Ie.index === 0) {
          we.ignoreMatch();
          return;
        }
      }
      ...
      built_in: o,
      "variable.language": l
    }, m = "[0-9](_?[0-9])*", A = `\\.(${m})`, k = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*", L = {
      className: "number",
      variants: [
        // DecimalLiteral
        { begin: `(\\b(${k})((${A})|\\.)?|(${A}))[eE][+-]?(${m})\\b` },
        { begin: `\\b(${k})\\b((${A})\\b|\\.)?|(${A})\\b` },
        // DecimalBigIntegerLiteral
        { begin: "\\b(0|[1-9](_?[0-9])*)n\\b" },
        // NonDecimalIntegerLiteral
    ...
    const q = [].concat(S, v.contains), Z = q.concat([
      // eat recursive parens in sub expressions
      {
        begin: /(\s*)\(/,
        end: /\)/,
    ...
    return {
      ...
      keywords: _,
      // this will be extended by TypeScript
      exports: { PARAMS_CONTAINS: Z, CLASS_REFERENCE: D },
      illegal: /#(?![$_A-z])/,
      contains: [
        u.SHEBANG({
          label: "shebang",
  ...
  function f(u) {
    const g = u.regex, b = c(u), x = s, N = [
      ...
      const S = T.contains.findIndex((K) => K.label === r);
      if (S === -1)
        throw new Error("can not find mode to replace");
      T.contains.splice(S, 1, E);
    };
    Object.assign(b.keywords, A), b.exports.PARAMS_CONTAINS.push(k);
    const v = b.contains.find((T) => T.scope === "attr"), w = Object.assign(
      {},
      v,
      { match: g.concat(x, g.lookahead(/\s*\?:/)) }
    );
    b.exports.PARAMS_CONTAINS.push([
      ...
      w
      // Added for optional property assignment highlighting
    ]), L(b, "shebang", u.SHEBANG()), L(b, "use_strict", _);
    const p = b.contains.find((T) => T.label === "func.def");
    return p.relevance = 0, Object.assign(b, {
      name: "TypeScript",
      aliases: [
        "ts",
        "tsx",
...
function e_() {
  ...
  function s(n) {
    ...
    }, a = /\d{1,2}\/\d{1,2}\/\d{4}/, l = /\d{4}-\d{1,2}-\d{1,2}/, o = /(\d|1[012])(:\d+){0,2} *(AM|PM)/, c = /\d{1,2}(:\d{1,2}){1,2}/, f = {
      className: "literal",
      variants: [
        {
...
function n_() {
  ...
  Ws = 1;
  var s = /* @__PURE__ */ _a();
  return s.registerLanguage("xml", /* @__PURE__ */ yc()), s.registerLanguage("bash", /* @__PURE__ */ Ec()), s.registerLanguage("c", /* @__PURE__ */ wc()), s.registerLanguage("cpp", /* @__PURE__ */ xc()), s.registerLanguage("csharp", /* @__PURE__ */ Sc()), s.registerLanguage("css", /* @__PURE__ */ Nc()), s.registerLanguage("markdown", /* @__PURE__ */ Tc()), s.registerLanguage("diff", /* @__PURE__ */ kc()), s.registerLanguage("ruby", /* @__PURE__ */ Oc()), s.registerLanguage("go", /* @__PURE__ */ Ac()), s.registerLanguage("graphql", /* @__PURE__ */ Rc()), s.registerLanguage("ini", /* @__PURE__ */ Cc()), s.registerLanguage("java", /* @__PURE__ */ Ic()), s.registerLanguage("javascript", /* @__PURE__ */ Mc()), s.registerLanguage("json", /* @__PURE__ */ Lc()), s.registerLanguage("kotlin", /* @__PURE__ */ Dc()), s.registerLanguage("less", /* @__PURE__ */ Bc()), s.registerLanguage("lua", /* @__PURE__ */ Pc()), s.registerLanguage("makefile", /* @__PURE__ */ Uc()), s.registerLanguage("perl", /* @__PURE__ */ $c()), s.registerLanguage("objectivec", /* @__PURE__ */ zc()), s.registerLanguage("php", /* @__PURE__ */ Fc()), s.registerLanguage("php-template", /* @__PURE__ */ Kc()), s.registerLanguage("plaintext", /* @__PURE__ */ Gc()), s.registerLanguage("python", /* @__PURE__ */ qc()), s.registerLanguage("python-repl", /* @__PURE__ */ Hc()), s.registerLanguage("r", /* @__PURE__ */ Wc()), s.registerLanguage("rust", /* @__PURE__ */ jc()), s.registerLanguage("scss", /* @__PURE__ */ Vc()), s.registerLanguage("shell", /* @__PURE__ */ Zc()), s.registerLanguage("sql", /* @__PURE__ */ Yc()), s.registerLanguage("swift", /* @__PURE__ */ Xc()), s.registerLanguage("yaml", /* @__PURE__ */ Qc()), s.registerLanguage("typescript", /* @__PURE__ */ Jc()), s.registerLanguage("vbnet", /* @__PURE__ */ e_()), s.registerLanguage("wasm", /* @__PURE__ */ t_()), s.HighlightJS = s, s.default = s, ii = s, ii;
}
n_();
var i_ = /* @__PURE__ */ _a();
const si = /* @__PURE__ */ cc(i_);
var js = Ma({ props: { code: { type: String, required: !0 }, language: { type: String, default: "" }, autodetect: { type: Boolean, default: !0 }, ignoreIllegals: { type: Boolean, default: !0 } }, setup: function(s) {
  var n = Q(s.language);
  Ye((function() {
    return s.language;
  }), (function(i) {
  ...
  return Oi("pre", {}, [Oi("code", { class: this.className, innerHTML: this.highlightedCode })]);
...
}, a_ = { class: "vue-lab__code-preview" }, r_ = { class: "vue-lab__code-preview__content" };
function o_(s, n, t, e, i, a) {
  return R(), $("div", a_, [
    n[0] || (n[0] = M(
      "div",
...
const ua = /* @__PURE__ */ ie(s_, [["render", o_], ["__scopeId", "data-v-ba1811dc"], ["__file", "./index.vue"]]), l_ = {
  __name: "index",
  props: {
  ...
  setup(s, { expose: n }) {
    ...
    let i = Q({});
    const a = Q(null), l = Q(null), o = Q(/* @__PURE__ */ new Map()), c = Q(null), f = Q(null), u = Q(null), g = Q(null), b = Q(!0), x = Q({
      vueLabloading: !0
    }), N = Q({});
    let y = Ut([]);
    Fe(async () => {
    ...
    const d = async () => {
      ...
      const I = t.configuration?.[t.name?.toLocaleLowerCase()], O = Object.keys(I.propsConfig);
      y = O.map((Y) => ({
        ctrl: I.propsConfig[Y].type,
        value: I.propsConfig[Y].value,
        title: I.propsConfig[Y].ctrlTitle,
        variants: I.propsConfig[Y].variants,
        isCtrl: I.propsConfig[Y].ctrl,
        field: Y
      })).filter((Y) => Y.isCtrl);
      const te = _(O, I.propsConfig);
      N.value = O.reduce((Y, z) => ({
        ...Y,
        [z]: I.propsConfig[z].type
      }), {}), i.value = { ...i.value, ...te }, x.value = { ...i.value }, a.value = I?.description, l.value = m(O, I.propsConfig), o.value = A(O, I.propsConfig), c.value = k(I.events), f.value = I.slots || [], u.value = L(I.slots, !0), g.value = L(I.slots, !1), b.value = !0;
    }, _ = (I, O) => I.reduce((D, te) => ({
      ...D,
      [te]: E(te, O)
    }), { vueLabloading: !0 }), m = (I, O) => I.map((D) => ({
      name: D,
      type: O[D].type,
      values: r(O[D].variants),
      optional: O[D].optional || !1,
      default: O[D].default,
      description: O[D].description
    })), A = (I, O) => new Map(I.map((D) => [D, O[D]])), k = (I) => I ? Object.keys(I).map((O) => ({
      name: O,
      func: I[O]?.func || (() => {
        alert(`Event ${O} triggered!`);
      }),
      isExampleCode: !!I[O]?.isExampleCode,
      description: I[O]?.description
    })) : null, L = (I, O) => I ? I.filter((D) => O ? D.name : !D.name).map((D) => ({
      ...D,
      value: D.type === "component" ? Ai(D.value) : D.value
    })) : null, v = P(() => !!f.value?.length), w = P(() => {
      const I = [], O = c.value ? c.value.map((Y) => `@${Y.name}="${Y.name}Handler"`).join(" ") : "";
      O?.length && c.value.forEach((Y) => {
        Y.isExampleCode && I.push(`const ${Y.name}Handler = ${Y.func.toString()}`);
      });
      const D = Object.entries(i.value).filter((Y) => Y[0] != "vueLabloading").map(([Y, z]) => {
        const ue = o.value.get(Y), ye = /* @__PURE__ */ new Map([["array", !0], ["object", !0], ["dictionary", !0], ["variable", !0], ["list", !0]]);
        if (z == null && ue?.optional)
          return null;
        if (ye.has(N.value[Y])) {
          const ge = `${Y}Val`, Ce = Array.isArray(z) ? JSON.stringify([...z.slice(0, 1), "..."]) : typeof z == "function" ? z.toString() : JSON.stringify(z);
          return ue.isExampleCode && I.push(`const ${ge} = ${Ce}`), `:${Y}="${ge}"`;
        } else {
          if (typeof z == "boolean")
            return `:${Y}="${!!z}"`;
          if (typeof z == "object" || typeof z == "number") {
            const ge = z?.__name || z?.__name || z;
            return `:${Y}="${ge}"`;
          }
          return `${Y}="${z}"`;
        }
      }).sort().filter(Boolean).join(" "), te = I.length ? `<script setup>${I.join(`
`)}<\/script>

` : "";
      if (v.value) {
        const Y = f.value.map((z) => {
          if (z.type === "text" || z.type === "html")
            return z.value;
          if (z.type === "component") {
            const ue = z.name ? `v-slot:${z.name}` : "";
            let ye = typeof z.value == "function" ? z.value() : null;
            if (ye) {
              ye = typeof ye == "function" ? [ye()] : Array.isArray(ye) ? ye : [ye];
              const Be = ye?.map((_e) => {
                const re = _e.type.__name || _e.type.name || _e.type, we = T(_e.props) || "", fe = _e?.children;
                if (fe) {
                  if (typeof fe == "string")
                    return `<${re} ${we}>${fe}</${re}>`;
                  if (typeof fe == "object") {
                    const Ie = (fe.default ? [fe.default()] : []).map((Ne) => {
                      const Qe = T(Ne?.props) || "", Je = Ne.type.__name || Ne.type.name || Ne.type;
                      return typeof Ne.children == "string" ? `<${Je} ${Qe}>${Ne.children}</${Je}>` : `<${Je} ${Qe}/>`;
                    }).join(`
    `);
                    return `<${re} ${we}>
    ${Ie}
    ...
    ${Be}
            ...
            const ge = z?.value?.__name || z?.value?.name;
            if (!ge) return null;
            const Ce = T(z.props) || "";
            return `<template ${ue}><${ge} ${Ce}/></template>`;
          }
        }).join(`
`);
        return `
    ...
    `;
      ...
      return `${te}<${t.name} ${D} ${O} />`;
    }), p = P(() => c.value?.length ? c.value.reduce((I, O) => ({
      ...I,
      [O.name]: O.func
    }), {}) : {}), T = (I) => I ? Array.isArray(I) ? I.map((O) => O.type === "number" || O.type === "boolean" || O.type === "variable" ? `:${O.name}="${O.value}"` : O.type === "text" ? `${O.name}="${O.value}"` : null).filter(Boolean).sort().join(" ") : Object.entries(I).map(([O, D]) => {
      if (typeof D == "number" || typeof D == "boolean")
        return `:${O}="${D}"`;
      if (typeof D == "string")
        return `${O}="${D}"`;
      if (typeof D == "object") {
        const te = Array.isArray(D) ? "options" : "dictionary";
        return `:${O}="${te}"`;
      } else
        return null;
    }).filter(Boolean).sort().join(" ") : "", r = (I) => Array.isArray(I) ? I?.filter((O) => O != null && O !== void 0 && O !== "").join(" | ") : typeof I == "boolean" ? I : null, E = (I, O) => O[I].value, S = ({ ctrl: I, value: O }) => {
      i.value[I] = O;
    }, K = () => {
      i.value = { ...x.value };
    }, q = P(() => e.value && i.value.vueLabloading);
    Ye(() => t.name, async () => {
      await d();
    });
    const Z = { props: t, comp: e, get config() {
      return i;
    }, set config(I) {
      i = I;
    }, description: a, propsData: l, propsMap: o, eventsData: c, slotsData: f, namedSlotsData: u, unnamedSlotsData: g, isLoading: b, defaultConfig: x, types: N, get controls() {
      return y;
    }, set controls(I) {
      y = I;
    }, loadData: d, getBinds: _, getPropsData: m, getPropsMap: A, getEventsData: k, getSlotsData: L, isSlots: v, exampleCode: w, eventHandlers: p, getSlotAttributes: T, getValues: r, getBindValue: E, handleCTRLInput: S, resetConfig: K, isComponent: q, computed: P, onMounted: Fe, reactive: Ut, ref: Q, watch: Ye, markRaw: Ai, get loadConfig() {
      return lc;
    }, get ControlBlock() {
      return ia;
    }, get Page() {
...
}, c_ = { class: "vue-lab__component" }, __ = { class: "vue-lab__component__header" }, u_ = { class: "vue-lab__component__header-title" }, d_ = { class: "vue-lab__component__content custom-scroll--simple" }, p_ = {
  key: 2,
...
function h_(s, n, t, e, i, a) {
  return e.isLoading ? (R(), V(e.Page, {
    key: 0,
    ...
    default: ve(() => [
      M("div", c_, [
        ...
        M("div", d_, [
          e.description ? (R(), V(e.Description, {
            key: 0,
            description: e.description
          }, null, 8, ["description"])) : ne("v-if", !0),
          e.isComponent ? (R(), V(e.Divider, { key: 1 })) : ne("v-if", !0),
          e.isComponent ? (R(), $("div", p_, [
            (R(), V(
              ct(e.comp),
              li(e.config, La(e.eventHandlers)),
              Da({
                default: ve(() => [
                  (R(!0), $(
                    he,
                    null,
                    Se(e.unnamedSlotsData, (l, o) => (R(), $(
                      he,
                      {
                        key: `unnamed-component-slot-${l.name}-${o}`
                      },
                      [
                        e.unnamedSlotsData?.length ? (R(), V(e.ComponentSlot, {
                          key: 0,
                          slotConfig: l
                        }, null, 8, ["slotConfig"])) : ne("v-if", !0)
                      ],
                      64
                      /* STABLE_FRAGMENT */
                    ))),
                ...
                Se(e.namedSlotsData, (l, o) => ({
                  name: l.name,
                  fn: ve(() => [
                    e.namedSlotsData?.length ? (R(), V(e.ComponentSlot, {
                      key: 0,
                      slotConfig: l
                    }, null, 8, ["slotConfig"])) : ne("v-if", !0)
                  ])
          ...
          e.exampleCode ? (R(), V(e.Divider, { key: 3 })) : ne("v-if", !0),
          e.isComponent && e.exampleCode ? (R(), V(e.CodePreview, {
            key: 4,
            code: e.exampleCode,
            "preview-code": e.exampleCode
          }, null, 8, ["code", "preview-code"])) : ne("v-if", !0),
          e.propsData ? (R(), V(e.Divider, { key: 5 })) : ne("v-if", !0),
          e.isComponent && e.propsData ? (R(), V(e.PropsDescription, {
            key: 6,
            data: e.propsData
          }, null, 8, ["data"])) : ne("v-if", !0),
          e.eventsData ? (R(), V(e.Divider, { key: 7 })) : ne("v-if", !0),
          e.isComponent && e.eventsData ? (R(), V(e.EventsDescription, {
            key: 8,
            data: e.eventsData
          }, null, 8, ["data"])) : ne("v-if", !0)
        ])
      ]),
      e.controls.length ? (R(), $("div", f_, [
        ke(e.ControlBlock, {
          options: e.controls,
          values: e.config,
...
const g_ = /* @__PURE__ */ ie(l_, [["render", h_], ["__scopeId", "data-v-432c94c6"], ["__file", "./index.vue"]]), m_ = {
  __name: "index",
  props: {
    options: { type: Array, default: () => [] },
    description: { type: String, default: null },
...
}, b_ = { class: "vue-lab-colors__component" }, v_ = { class: "vue-lab-colors__component__header" }, y_ = { class: "vue-lab-colors__component__header-title" }, E_ = { class: "vue-lab-colors__component__content custom-scroll--simple" };
function w_(s, n, t, e, i, a) {
  return R(), V(e.Page, {
    "is-controls": !1,
    ...
    default: ve(() => [
      M("div", b_, [
        ...
        M("div", E_, [
          t.description ? (R(), V(e.Description, {
            key: 0,
          ...
          (R(!0), $(
            ...
            Se(e.colorGroup, (l, o) => (R(), $(
              ...
              [
                ...
                o != e.colorGroup.length - 1 ? (R(), V(e.Divider, { key: 0 })) : ne("v-if", !0)
              ],
              64
              /* STABLE_FRAGMENT */
            ))),
...
const x_ = /* @__PURE__ */ ie(m_, [["render", w_], ["__scopeId", "data-v-bf59dc62"], ["__file", "./index.vue"]]), S_ = {
  __name: "IconGroup",
  props: {
    group: {
      type: Object,
  ...
  setup(s, { expose: n, emit: t }) {
    n();
    const e = s, i = t, l = { props: e, emit: i, handleIconSelect: (o) => {
      i("input", o.name);
    } };
    return Object.defineProperty(l, "__isScriptSetup", { enumerable: !1, value: !0 }), l;
  }
}, N_ = { class: "vue-lab-icons__group" }, T_ = { class: "vue-lab-icons__group-title" }, k_ = { class: "vue-lab-icons__group-body" }, O_ = ["onClick"], A_ = { class: "vue-lab-icons__group-item-name" };
  ...
  return R(), $("div", N_, [
    ...
    M("div", k_, [
      (R(!0), $(
        he,
        null,
        Se(t.group.components, (l, o) => (R(), $("div", {
...
const C_ = /* @__PURE__ */ ie(S_, [["render", R_], ["__scopeId", "data-v-89316d17"], ["__file", "./IconGroup.vue"]]), I_ = {
  __name: "index",
  props: {
    options: {
      type: Array,
  ...
  setup(s, { expose: n, emit: t }) {
    ...
    const e = s;
    let i = Q({});
    const a = Q(null), l = Q(null), o = Q(/* @__PURE__ */ new Map()), c = Q(null), f = Q(!0), u = Q({
      vueLabloading: !0
    }), g = Q({});
    let b = Ut([]);
    Fe(async () => {
    ...
    const x = t, N = Q(""), y = P(() => N.value ? e.options.filter(
      (O) => O.name?.toLowerCase().includes(N?.value.toLowerCase())
    ) : e.options), d = P(() => {
      const O = [...new Set(y.value.map((D) => D.group))];
      return new Map(O.map((D) => [D, y.value.filter((te) => te.group == D)]));
    }), _ = P(() => [...new Set(y.value.map((D) => D.group))].map((D) => ({ name: D, components: d.value.get(D) }))), m = (O) => {
      N.value = O;
    }, A = async () => {
      f.value = !1, i.value = { vueLabloading: !1 };
      const O = e.configuration, D = Object.keys(O.propsConfig);
      b = [
        ...D.map((z) => ({
      ...
      const Y = k(D, O.propsConfig);
      g.value = D.reduce((z, ue) => ({
        ...z,
        [ue]: O.propsConfig[ue].type
      }), {}), i.value = { ...i.value, ...Y }, u.value = { ...i.value }, a.value = O?.description, l.value = p(D, O.propsConfig), o.value = T(D, O.propsConfig), c.value = r(O.events), f.value = !0;
    }, k = (O, D) => O.reduce((te, Y) => ({
      ...te,
      [Y]: L(Y, D)
    }), { vueLabloading: !0 }), L = (O, D) => D[O].value, v = P(() => i.value.vueLabloading), w = (O) => Array.isArray(O) ? O?.filter((D) => D != null && D !== void 0 && D !== "").join(" | ") : typeof O == "boolean" ? O : null, p = (O, D) => O.map((te) => ({
      name: te,
      type: D[te].type,
      values: w(D[te].variants),
      optional: D[te].optional || !1,
      default: D[te].default,
      description: D[te].description
    })), T = (O, D) => new Map(O.map((te) => [te, D[te]])), r = (O) => O ? Object.keys(O).map((D) => ({
      name: D,
      description: O[D].description
    })) : null, E = P(() => {
      const O = c.value ? c.value.map((z) => `@${z.name}="${z.name}Handler"`).join(" ") : "", D = new Map(b.map((z) => [z.field, z.isCodeHiden])), te = Object.entries(i.value).filter((z) => z[0] != "vueLabloading").map(([z, ue]) => {
        if (D.get(z))
          return null;
        const ye = o.value.get(z);
        if (ue == null && ye?.optional)
          return null;
        if (g.value[z] === "variable") {
          const ge = `${z}Val`;
          return `:${z}="${ge}"`;
        } else
          return typeof ue == "boolean" ? `:${z}="${!!ue}"` : typeof ue == "object" || typeof ue == "number" ? `:${z}="${ue}"` : `${z}="${ue}"`;
      }).sort().filter(Boolean).join(" ");
      return `<${S.value ? Ri(S.value.name) : "Component"} ${te} ${O} />`;
    }), S = P(() => i.value?.icon ? e.options?.find((O) => O.name === i.value.icon) : e.options?.[0]), I = { props: e, get config() {
      return i;
    }, set config(O) {
      i = O;
    }, description: a, propsData: l, propsMap: o, eventsData: c, isLoading: f, defaultConfig: u, types: g, get controls() {
      return b;
    }, set controls(O) {
      b = O;
    }, emit: x, searchTerm: N, filteredOptions: y, optionMap: d, groups: _, handleSearch: m, loadData: A, getBinds: k, getBindValue: L, isComponent: v, getValues: w, getPropsData: p, getPropsMap: T, getEventsData: r, exampleCode: E, selectedIcon: S, handleCTRLInput: ({ ctrl: O, value: D }) => {
      i.value[O] = D;
    }, resetConfig: () => {
      i.value = { ...u.value };
    }, handleSelectIcon: (O) => {
      e.options.find((te) => te.name === O) && (i.value.icon = O);
      ...
      return ui;
    }, IconGroup: C_, get Page() {
      return di;
    }, get Divider() {
      return Ft;
    }, get ControlBlock() {
      return ia;
    }, CodePreview: ua, get toPascalCase() {
      return Ri;
    } };
    return Object.defineProperty(I, "__isScriptSetup", { enumerable: !1, value: !0 }), I;
  }
}, M_ = { class: "vue-lab-icons__body" }, L_ = { class: "vue-lab-icons__body-components custom-scroll--simple" }, D_ = { class: "vue-lab-icons__body-search" }, B_ = { class: "vue-lab-icons__body-components-list" }, P_ = {
  key: 0,
  class: "vue-lab-icons__controls"
};
function U_(s, n, t, e, i, a) {
  return e.isLoading ? (R(), V(e.Page, {
    key: 0,
    "is-controls": !!e.controls.length,
    class: "vue-lab-icons"
    ...
    default: ve(() => [
      M("div", M_, [
        ...
        M("div", L_, [
          ...
          M("div", D_, [
            ke(e.Search, { onInput: e.handleSearch })
          ]),
          M("div", B_, [
            e.groups.length ? (R(!0), $(
              he,
              { key: 1 },
              Se(e.groups, (l) => (R(), V(e.IconGroup, {
                key: l.name,
                group: l,
                config: e.config,
          ...
          e.exampleCode ? (R(), V(e.Divider, { key: 1 })) : ne("v-if", !0),
          e.isComponent && e.exampleCode ? (R(), V(e.CodePreview, {
            key: 2,
            code: e.exampleCode,
            "preview-code": e.exampleCode
          }, null, 8, ["code", "preview-code"])) : ne("v-if", !0),
          e.propsData ? (R(), V(e.Divider, { key: 3 })) : ne("v-if", !0),
          e.isComponent && e.propsData ? (R(), V(e.PropsDescription, {
            key: 4,
            data: e.propsData
          }, null, 8, ["data"])) : ne("v-if", !0),
          e.eventsData ? (R(), V(e.Divider, { key: 5 })) : ne("v-if", !0),
          e.isComponent && e.eventsData ? (R(), V(e.EventsDescription, {
            key: 6,
            data: e.eventsData
          }, null, 8, ["data"])) : ne("v-if", !0)
...
const $_ = /* @__PURE__ */ ie(I_, [["render", U_], ["__scopeId", "data-v-ffc66622"], ["__file", "./index.vue"]]), z_ = {
  ...
  const c = Object.keys(i || {}), f = c.reduce((A, k) => ({ ...A, [k.toLocaleLowerCase()]: i[k] }), {}), u = new Map(c.map((A) => [A, i[A].group])), g = s ? Object.keys(s).map((A) => ({
    name: A,
    path: `/${A}`,
    group: u.get(A)
  })) : [];
  let b = l ? [...n || g, ...l] : n || g;
  const x = b.reduce((A, k) => k.index > A ? k.index : A, 0);
  b = b.map((A, k) => ({ ...A, index: A.index || x + k + 1 })), b.sort((A, k) => A.index - k.index);
  const N = /* @__PURE__ */ new Map([
    ["colors", x_],
    ["icons", $_]
  ]), y = (l || []).map((A) => {
    const k = N.get(A.type);
    return k ? {
      path: A.path,
      name: A.name,
      component: k,
